...
public class Languages {
   ...
   private static String langResourceName(NameType var0) {
      return String.format("org/apache/commons/codec/language/bm/%s_languages.txt", new Object[]{var0.getName()});
   }
   ...
   public abstract static class LanguageSet {
      ...
      public static Languages.LanguageSet from(Set<String> var0) {
         return (Languages.LanguageSet)(var0.isEmpty()?Languages.NO_LANGUAGES:new Languages.SomeLanguages(var0, null));
      }
