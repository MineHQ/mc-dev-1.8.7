...
public class PhoneticEngine {
   ...
   private PhoneticEngine.PhonemeBuilder applyFinalRules(PhoneticEngine.PhonemeBuilder var1, Map<String, List<Rule>> var2) {
      if(var2 == null) {
         ...
         TreeSet var3 = new TreeSet(Rule.Phoneme.COMPARATOR);
         ...
         while(var4.hasNext()) {
            ...
            var3.addAll(var6.getPhonemes());
         }

         return new PhoneticEngine.PhonemeBuilder(var3, (PhoneticEngine.SyntheticClass_1)null);
      }
   }
   ...
   static final class PhonemeBuilder {
      ...
      // $FF: synthetic method
      PhonemeBuilder(Set var1, PhoneticEngine.SyntheticClass_1 var2) {
         this(var1);
      }
   }
}
