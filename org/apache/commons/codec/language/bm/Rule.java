...
public class Rule {
   ...
   private static String createResourceName(NameType var0, RuleType var1, String var2) {
      return String.format("org/apache/commons/codec/language/bm/%s_%s_%s.txt", new Object[]{var0.getName(), var1.getName(), var2});
   }
   ...
   private static Scanner createScanner(String var0) {
      String var1 = String.format("org/apache/commons/codec/language/bm/%s.txt", new Object[]{var0});
   ...
   public static List<Rule> getInstance(NameType var0, RuleType var1, String var2) {
      return getInstance(var0, var1, Languages.LanguageSet.from(new HashSet(Arrays.asList(new String[]{var2}))));
   }
   ...
   public static Map<String, List<Rule>> getInstanceMap(NameType var0, RuleType var1, String var2) {
      ...
      if(var3 == null) {
         throw new IllegalArgumentException(String.format("No rules found for %s, %s, %s.", new Object[]{var0.getName(), var1.getName(), var2}));
      } else {
         return var3;
      }
   }
            ...
            if(var6.length() != 0) {
               if(var6.startsWith("#include")) {
                  ...
                  try {
                     ...
                     final Rule.PhonemeExpr var12 = parsePhonemeExpr(stripQuotes(var18[3]));
   ...
   public boolean patternAndContextMatches(CharSequence var1, int var2) {
      if(var2 < 0) {
         ...
         int var4 = var2 + var3;
         return var4 > var1.length()?false:(!var1.subSequence(var2, var4).equals(this.pattern)?false:(!this.rContext.isMatch(var1.subSequence(var4, var1.length()))?false:this.lContext.isMatch(var1.subSequence(0, var2))));
      }
   }
   ...
   public static final class Phoneme implements Rule.PhonemeExpr {
      public static final Comparator<Rule.Phoneme> COMPARATOR = new Comparator() {
         ...
         public int compare(Object var1, Object var2) {
            return this.compare((Rule.Phoneme)var1, (Rule.Phoneme)var2);
         }
      };
