...
public class XmlStreamReader extends Reader {
   ...
   public XmlStreamReader(URLConnection var1, String var2) throws IOException {
      ...
      if(!(var1 instanceof HttpURLConnection) && var4 == null) {
         this.encoding = this.doRawStream(var6, var7, var3);
      } else {
         this.encoding = this.doHttpStream(var6, var7, var4, var3);
      }
      ...
      if(var1 != null) {
         ...
         if(var1.equals("UTF-8")) {
            if(var2 != null && !var2.equals("UTF-8")) {
               var4 = MessageFormat.format("Invalid encoding, BOM [{0}] XML guess [{1}] XML prolog [{2}] encoding mismatch", new Object[]{var1, var2, var3});
            ...
            if(!var1.equals("UTF-32BE") && !var1.equals("UTF-32LE")) {
               var4 = MessageFormat.format("Invalid encoding, BOM [{0}] XML guess [{1}] XML prolog [{2}] unknown BOM", new Object[]{var1, var2, var3});
               throw new XmlStreamReaderException(var4, var1, var2, var3);
         ...
         return var2 != null && var3 != null?(!var3.equals("UTF-16") || !var2.equals("UTF-16BE") && !var2.equals("UTF-16LE")?var3:var2):(this.defaultEncoding == null?"UTF-8":this.defaultEncoding);
      }
   }
   ...
   String calculateHttpEncoding(String var1, String var2, String var3, String var4, boolean var5) throws IOException {
      if(var5 && var4 != null) {
         ...
         String var10;
         if(!var8 && !var9) {
            var10 = MessageFormat.format("Invalid encoding, CT-MIME [{0}] CT-Enc [{1}] BOM [{2}] XML guess [{3}] XML prolog [{4}], Invalid MIME", new Object[]{var6, var7, var2, var3, var4});
            throw new XmlStreamReaderException(var10, var6, var7, var2, var3, var4);
         } else if(var7 == null) {
            return var8?this.calculateRawEncoding(var2, var3, var4):(this.defaultEncoding == null?"US-ASCII":this.defaultEncoding);
         } else if(!var7.equals("UTF-16BE") && !var7.equals("UTF-16LE")) {
            if(var7.equals("UTF-16")) {
               if(var2 != null && var2.startsWith("UTF-16")) {
                  return var2;
               } else {
                  var10 = MessageFormat.format("Invalid encoding, CT-MIME [{0}] CT-Enc [{1}] BOM [{2}] XML guess [{3}] XML prolog [{4}], encoding mismatch", new Object[]{var6, var7, var2, var3, var4});
                  throw new XmlStreamReaderException(var10, var6, var7, var2, var3, var4);
               }
               ...
               var10 = MessageFormat.format("Invalid encoding, CT-MIME [{0}] CT-Enc [{1}] BOM [{2}] XML guess [{3}] XML prolog [{4}], BOM must be NULL", new Object[]{var6, var7, var2, var3, var4});
               throw new XmlStreamReaderException(var10, var6, var7, var2, var3, var4);
            } else {
               return var7;
            }
   ...
   private static String getXmlProlog(InputStream var0, String var1) throws IOException {
      ...
      if(var1 != null) {
         ...
         String var8;
         for(var8 = null; var6 != -1 && var7 == -1 && var4 < 4096; var7 = var8.indexOf(62)) {
            var4 += var6;
            var5 -= var6;
