...
public class ReversedLinesFileReader implements Closeable {
   ...
   public ReversedLinesFileReader(File var1, int var2, Charset var3) throws IOException {
      ...
      this.currentFilePart = new ReversedLinesFileReader.FilePart(this.totalBlockCount, var4, (byte[])null);
   ...
   private class FilePart {
      ...
      // $FF: synthetic method
      FilePart(long var2, int var4, byte[] var5, ReversedLinesFileReader.SyntheticClass_1 var6) throws IOException {
         this();
      }
   }
}
