...
public class BOMInputStream extends ProxyInputStream {
   ...
   private static final Comparator<ByteOrderMark> ByteOrderMarkLengthComparator = new Comparator() {
      ...
      public int compare(Object var1, Object var2) {
         return this.compare((ByteOrderMark)var1, (ByteOrderMark)var2);
      }
   };

   public BOMInputStream(InputStream var1) {
      this(var1, false, new ByteOrderMark[]{ByteOrderMark.UTF_8});
   }

   public BOMInputStream(InputStream var1, boolean var2) {
      this(var1, var2, new ByteOrderMark[]{ByteOrderMark.UTF_8});
   }
   ...
   public long skip(long var1) throws IOException {
      while(var1 > 0L && this.readFirstBytes() >= 0) {
         --var1;
      }
