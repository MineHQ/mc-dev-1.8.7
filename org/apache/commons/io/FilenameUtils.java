...
public class FilenameUtils {
      ...
      if(var0 == null) {
         ...
         if(var3 == 0) {
            ...
            if(var4 < 0) {
               ...
               for(var8 = var4 + 1; var8 < var3; ++var8) {
                  if(var5[var8] == var1 && var5[var8 - 1] == 46 && (var8 == var4 + 1 || var5[var8 - 2] == var1)) {
                     if(var8 == var3 - 1) {
                        var10 = true;
                     }
               ...
               for(var8 = var4 + 2; var8 < var3; ++var8) {
                  if(var5[var8] == var1 && var5[var8 - 1] == 46 && var5[var8 - 2] == 46 && (var8 == var4 + 2 || var5[var8 - 3] == var1)) {
                     if(var8 == var4 + 2) {
                        return null;
                     }
   ...
   public static boolean directoryContains(String var0, String var1) throws IOException {
      if(var0 == null) {
         ...
         return var1 == null?false:(IOCase.SYSTEM.checkEquals(var0, var1)?false:IOCase.SYSTEM.checkStartsWith(var1, var0));
      }
   }
   ...
   public static String separatorsToSystem(String var0) {
      return var0 == null?null:(isSystemWindows()?separatorsToWindows(var0):separatorsToUnix(var0));
   }
      ...
      if(var0 == null) {
         ...
         if(var1 == 0) {
            ...
            if(var2 == 58) {
               ...
               return var2 == 126?2:(isSeparator(var2)?1:0);
            } else {
               int var4;
               if(var2 == 126) {
                  ...
                  if(var3 == 58) {
                     ...
                     return var2 >= 65 && var2 <= 90?(var1 != 2 && isSeparator(var0.charAt(2))?3:2):-1;
   ...
   public static String getPrefix(String var0) {
      if(var0 == null) {
         ...
         return var1 < 0?null:(var1 > var0.length()?var0 + '/':var0.substring(0, var1));
      }
   }
   ...
   private static String doGetPath(String var0, int var1) {
      if(var0 == null) {
         ...
         if(var2 < 0) {
            ...
            int var4 = var3 + var1;
            return var2 < var0.length() && var3 >= 0 && var2 < var4?var0.substring(var2, var4):"";
         }
      }
   }
