...
public final class Range<T> implements Serializable {
   ...
   public boolean contains(T var1) {
      return var1 == null?false:this.comparator.compare(var1, this.minimum) > -1 && this.comparator.compare(var1, this.maximum) < 1;
   }

   public boolean isAfter(T var1) {
      return var1 == null?false:this.comparator.compare(var1, this.minimum) < 0;
   }
   ...
   public boolean isEndedBy(T var1) {
      return var1 == null?false:this.comparator.compare(var1, this.maximum) == 0;
   }
   ...
   public int elementCompareTo(T var1) {
      if(var1 == null) {
         ...
         return this.isAfter(var1)?-1:(this.isBefore(var1)?1:0);
      }
   }

   public boolean containsRange(Range<T> var1) {
      return var1 == null?false:this.contains(var1.minimum) && this.contains(var1.maximum);
   }
   ...
   public boolean isOverlappedBy(Range<T> var1) {
      return var1 == null?false:var1.contains(this.minimum) || var1.contains(this.maximum) || this.contains(var1.minimum);
   }
   ...
   public Range<T> intersectionWith(Range<T> var1) {
      if(!this.isOverlappedBy(var1)) {
         throw new IllegalArgumentException(String.format("Cannot calculate intersection with non-overlapping range %s", new Object[]{var1}));
   ...
   public String toString(String var1) {
      return String.format(var1, new Object[]{this.minimum, this.maximum, this.comparator});
   }
