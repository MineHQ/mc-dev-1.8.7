...
public class ReflectionToStringBuilder extends ToStringBuilder {
   ...
   protected boolean accept(Field var1) {
      return var1.getName().indexOf(36) != -1?false:(Modifier.isTransient(var1.getModifiers()) && !this.isAppendTransients()?false:(Modifier.isStatic(var1.getModifiers()) && !this.isAppendStatics()?false:this.excludeFieldNames == null || Arrays.binarySearch(this.excludeFieldNames, var1.getName()) < 0));
   }
