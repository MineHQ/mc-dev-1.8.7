...
public class TypeUtils {
   ...
   public static Map<TypeVariable<?>, Type> determineTypeArguments(Class<?> var0, ParameterizedType var1) {
      Validate.notNull(var0, "cls is null", new Object[0]);
      Validate.notNull(var1, "superType is null", new Object[0]);
   ...
   public static boolean isInstance(Object var0, Type var1) {
      return var1 == null?false:(var0 == null?!(var1 instanceof Class) || !((Class)var1).isPrimitive():isAssignable(var0.getClass(), (Type)var1, (Map)null));
   }

   public static Type[] normalizeUpperBounds(Type[] var0) {
      Validate.notNull(var0, "null value specified for bounds array", new Object[0]);
      if(var0.length < 2) {
         return var0;
      } else {
   ...
   public static Type[] getImplicitBounds(TypeVariable<?> var0) {
      Validate.notNull(var0, "typeVariable is null", new Object[0]);
   ...
   public static Type[] getImplicitUpperBounds(WildcardType var0) {
      Validate.notNull(var0, "wildcardType is null", new Object[0]);
   ...
   public static boolean typesSatisfyVariables(Map<TypeVariable<?>, Type> var0) {
      Validate.notNull(var0, "typeVarAssigns is null", new Object[0]);
   ...
   public static final ParameterizedType parameterize(Class<?> var0, Map<TypeVariable<?>, Type> var1) {
      Validate.notNull(var0, "raw class is null", new Object[0]);
      Validate.notNull(var1, "typeArgMappings is null", new Object[0]);
   ...
   public static final ParameterizedType parameterizeWithOwner(Type var0, Class<?> var1, Type... var2) {
      Validate.notNull(var1, "raw class is null", new Object[0]);
      Object var3;
      if(var1.getEnclosingClass() == null) {
         Validate.isTrue(var0 == null, "no owner allowed for top-level %s", new Object[]{var1});
         var3 = null;
      } else if(var0 == null) {
         var3 = var1.getEnclosingClass();
      } else {
         Validate.isTrue(isAssignable(var0, var1.getEnclosingClass()), "%s is invalid owner type for parameterized %s", new Object[]{var0, var1});
         var3 = var0;
      }

      Validate.noNullElements((Object[])var2, "null type argument at index %s", new Object[0]);
      Validate.isTrue(var1.getTypeParameters().length == var2.length, "invalid number of type parameters specified: expected %s, got %s", new Object[]{Integer.valueOf(var1.getTypeParameters().length), Integer.valueOf(var2.length)});
      return new TypeUtils.ParameterizedTypeImpl(var1, (Type)var3, var2, null);
   }

   public static final ParameterizedType parameterizeWithOwner(Type var0, Class<?> var1, Map<TypeVariable<?>, Type> var2) {
      Validate.notNull(var1, "raw class is null", new Object[0]);
      Validate.notNull(var2, "typeArgMappings is null", new Object[0]);
   ...
   private static Type[] extractTypeArgumentsFrom(Map<TypeVariable<?>, Type> var0, TypeVariable<?>[] var1) {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ...
         Validate.isTrue(var0.containsKey(var7), "missing argument mapping for %s", new Object[]{toString(var7)});
   ...
   public static GenericArrayType genericArrayType(Type var0) {
      return new TypeUtils.GenericArrayTypeImpl((Type)Validate.notNull(var0, "componentType is null", new Object[0]), null);
   }

   public static boolean equals(Type var0, Type var1) {
      return ObjectUtils.equals(var0, var1)?true:(var0 instanceof ParameterizedType?equals((ParameterizedType)var0, var1):(var0 instanceof GenericArrayType?equals((GenericArrayType)var0, var1):(var0 instanceof WildcardType?equals((WildcardType)var0, var1):false)));
   }
   ...
   private static boolean equals(WildcardType var0, Type var1) {
      if(!(var1 instanceof WildcardType)) {
         ...
         WildcardType var2 = (WildcardType)var1;
         return equals(var0.getLowerBounds(), var2.getLowerBounds()) && equals(getImplicitUpperBounds(var0), getImplicitUpperBounds(var2));
      }
   }
   ...
   public static String toLongString(TypeVariable<?> var0) {
      Validate.notNull(var0, "var is null", new Object[0]);
   ...
   private static String wildcardTypeToString(WildcardType var0) {
      ...
      } else if(var3.length != 1 || !Object.class.equals(var3[0])) {
   ...
   private static String genericArrayTypeToString(GenericArrayType var0) {
      return String.format("%s[]", new Object[]{toString(var0.getGenericComponentType())});
   }
