...
public class FieldUtils {
   ...
   public static Field getField(Class<?> var0, String var1, boolean var2) {
      Validate.isTrue(var0 != null, "The class must not be null", new Object[0]);
      Validate.isTrue(StringUtils.isNotBlank(var1), "The field name must not be blank/empty", new Object[0]);
      ...
      while(var10.hasNext()) {
         ...
         try {
            ...
            Validate.isTrue(var9 == null, "Reference to field %s is ambiguous relative to %s; a matching field exists on two or more implemented interfaces.", new Object[]{var1, var0});
            var9 = var6;
   ...
   public static Object readStaticField(Field var0, boolean var1) throws IllegalAccessException {
      Validate.isTrue(var0 != null, "The field must not be null", new Object[0]);
      Validate.isTrue(Modifier.isStatic(var0.getModifiers()), "The field \'%s\' is not static", new Object[]{var0.getName()});
      return readField(var0, (Object)null, var1);
   }
   ...
   public static Object readStaticField(Class<?> var0, String var1, boolean var2) throws IllegalAccessException {
      ...
      Validate.isTrue(var3 != null, "Cannot locate field \'%s\' on %s", new Object[]{var1, var0});
   ...
   public static Object readDeclaredStaticField(Class<?> var0, String var1, boolean var2) throws IllegalAccessException {
      ...
      Validate.isTrue(var3 != null, "Cannot locate declared field %s.%s", new Object[]{var0.getName(), var1});
      return readStaticField(var3, false);
   }
   ...
   public static Object readField(Object var0, String var1, boolean var2) throws IllegalAccessException {
      Validate.isTrue(var0 != null, "target object must not be null", new Object[0]);
      Class var3 = var0.getClass();
      Field var4 = getField(var3, var1, var2);
      Validate.isTrue(var4 != null, "Cannot locate field %s on %s", new Object[]{var1, var3});
   ...
   public static Object readDeclaredField(Object var0, String var1, boolean var2) throws IllegalAccessException {
      ...
      Validate.isTrue(var4 != null, "Cannot locate declared field %s.%s", new Object[]{var3, var1});
      return readField(var4, var0, false);
   }
   ...
   public static void writeStaticField(Field var0, Object var1, boolean var2) throws IllegalAccessException {
      Validate.isTrue(var0 != null, "The field must not be null", new Object[0]);
      Validate.isTrue(Modifier.isStatic(var0.getModifiers()), "The field %s.%s is not static", new Object[]{var0.getDeclaringClass().getName(), var0.getName()});
      writeField(var0, (Object)null, var1, var2);
   }
   ...
   public static void writeStaticField(Class<?> var0, String var1, Object var2, boolean var3) throws IllegalAccessException {
      ...
      Validate.isTrue(var4 != null, "Cannot locate field %s on %s", new Object[]{var1, var0});
   ...
   public static void writeDeclaredStaticField(Class<?> var0, String var1, Object var2, boolean var3) throws IllegalAccessException {
      ...
      Validate.isTrue(var4 != null, "Cannot locate declared field %s.%s", new Object[]{var0.getName(), var1});
      writeField(var4, (Object)null, var2, false);
   }
   ...
   public static void writeField(Object var0, String var1, Object var2, boolean var3) throws IllegalAccessException {
      ...
      Validate.isTrue(var5 != null, "Cannot locate declared field %s.%s", new Object[]{var4.getName(), var1});
