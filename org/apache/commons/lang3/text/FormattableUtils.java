...
public class FormattableUtils {
   ...
   public static String toString(Formattable var0) {
      return String.format("%s", new Object[]{var0});
   }
   ...
   public static Formatter append(CharSequence var0, Formatter var1, int var2, int var3, int var4, char var5, CharSequence var6) {
      Validate.isTrue(var6 == null || var4 < 0 || var6.length() <= var4, "Specified ellipsis \'%1$s\' exceeds precision of %2$s", new Object[]{var6, Integer.valueOf(var4)});
      ...
      var1.format(var7.toString(), new Object[0]);
      return var1;
   }
}
