...
public abstract class StrMatcher {
   ...
   public static StrMatcher charSetMatcher(char... var0) {
      return (StrMatcher)(var0 != null && var0.length != 0?(var0.length == 1?new StrMatcher.CharMatcher(var0[0]):new StrMatcher.CharSetMatcher(var0)):NONE_MATCHER);
   }

   public static StrMatcher charSetMatcher(String var0) {
      return (StrMatcher)(StringUtils.isEmpty(var0)?NONE_MATCHER:(var0.length() == 1?new StrMatcher.CharMatcher(var0.charAt(0)):new StrMatcher.CharSetMatcher(var0.toCharArray())));
   }
