...
public class UnicodeUnescaper extends CharSequenceTranslator {
   ...
   public int translate(CharSequence var1, int var2, Writer var3) throws IOException {
      if(var1.charAt(var2) == 92 && var2 + 1 < var1.length() && var1.charAt(var2 + 1) == 117) {
         int var4;
         for(var4 = 2; var2 + var4 < var1.length() && var1.charAt(var2 + var4) == 117; ++var4) {
            ;
         }

         if(var2 + var4 < var1.length() && var1.charAt(var2 + var4) == 43) {
            ++var4;
         }
