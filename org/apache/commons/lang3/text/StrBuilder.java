...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
   ...
   public StrBuilder append(Object var1) {
      return var1 == null?this.appendNull():this.append(var1.toString());
   }
   ...
   public StrBuilder insert(int var1, boolean var2) {
      ...
      if(var2) {
         ...
         this.buffer[var1++] = 116;
         this.buffer[var1++] = 114;
         this.buffer[var1++] = 117;
         this.buffer[var1] = 101;
         this.size += 4;
      } else {
         this.ensureCapacity(this.size + 5);
         System.arraycopy(this.buffer, var1, this.buffer, var1 + 5, this.size - var1);
         this.buffer[var1++] = 102;
         this.buffer[var1++] = 97;
         this.buffer[var1++] = 108;
         this.buffer[var1++] = 115;
         this.buffer[var1] = 101;
         this.size += 5;
      }
   ...
   public StrBuilder trim() {
      if(this.size == 0) {
         ...
         int var3;
         for(var3 = 0; var3 < var1 && var2[var3] <= 32; ++var3) {
            ;
         }

         while(var3 < var1 && var2[var1 - 1] <= 32) {
            --var1;
         }
   ...
   public String leftString(int var1) {
      return var1 <= 0?"":(var1 >= this.size?new String(this.buffer, 0, this.size):new String(this.buffer, 0, var1));
   }

   public String rightString(int var1) {
      return var1 <= 0?"":(var1 >= this.size?new String(this.buffer, 0, this.size):new String(this.buffer, this.size - var1, var1));
   }
   ...
   public String midString(int var1, int var2) {
      ...
      return var2 > 0 && var1 < this.size?(this.size <= var1 + var2?new String(this.buffer, var1, this.size - var1):new String(this.buffer, var1, var2)):"";
   }
   ...
   public boolean equals(Object var1) {
      return var1 instanceof StrBuilder?this.equals((StrBuilder)var1):false;
   }
