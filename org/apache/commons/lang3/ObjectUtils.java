...
public class ObjectUtils {
   ...
   public static <T extends Comparable<? super T>> int compare(T var0, T var1, boolean var2) {
      return var0 == var1?0:(var0 == null?(var2?1:-1):(var1 == null?(var2?-1:1):var0.compareTo(var1)));
   }
   ...
   public static <T> T median(Comparator<T> var0, T... var1) {
      Validate.notEmpty(var1, "null/empty items", new Object[0]);
      Validate.noNullElements(var1);
      Validate.notNull(var0, "null comparator", new Object[0]);
   ...
   public static <T> T clone(T var0) {
      if(!(var0 instanceof Cloneable)) {
         ...
         if(var0.getClass().isArray()) {
            ...
            try {
               Method var7 = var0.getClass().getMethod("clone", new Class[0]);
               var1 = var7.invoke(var0, new Object[0]);
