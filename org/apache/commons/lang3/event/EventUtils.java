...
public class EventUtils {
   ...
   public static <L> void addEventListener(Object var0, Class<L> var1, L var2) {
      try {
         MethodUtils.invokeMethod(var0, "add" + var1.getSimpleName(), new Object[]{var2});
   ...
   private static class EventBindingInvocationHandler implements InvocationHandler {
      ...
      public Object invoke(Object var1, Method var2, Object[] var3) throws Throwable {
         return !this.eventTypes.isEmpty() && !this.eventTypes.contains(var2.getName())?null:(this.hasMatchingParametersMethod(var2)?MethodUtils.invokeMethod(this.target, this.methodName, var3):MethodUtils.invokeMethod(this.target, this.methodName, new Object[0]));
      }
