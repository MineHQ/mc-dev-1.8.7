...
public class EventListenerSupport<L> implements Serializable {
   ...
   public EventListenerSupport(Class<L> var1, ClassLoader var2) {
      this();
      Validate.notNull(var1, "Listener interface cannot be null.", new Object[0]);
      Validate.notNull(var2, "ClassLoader cannot be null.", new Object[0]);
      Validate.isTrue(var1.isInterface(), "Class {0} is not an interface", new Object[]{var1.getName()});
   ...
   public void addListener(L var1) {
      Validate.notNull(var1, "Listener object cannot be null.", new Object[0]);
