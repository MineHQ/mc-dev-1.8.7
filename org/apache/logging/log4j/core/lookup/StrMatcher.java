...
public abstract class StrMatcher {
   ...
   public static StrMatcher charSetMatcher(String var0) {
      return (StrMatcher)(Strings.isEmpty(var0)?NONE_MATCHER:(var0.length() == 1?new StrMatcher.CharMatcher(var0.charAt(0)):new StrMatcher.CharSetMatcher(var0.toCharArray())));
   }
