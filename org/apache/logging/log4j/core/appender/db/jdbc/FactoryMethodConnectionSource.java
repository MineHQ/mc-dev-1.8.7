   ...
   public static FactoryMethodConnectionSource createConnectionSource(@PluginAttribute("class") String var0, @PluginAttribute("method") String var1) {
      if(!Strings.isEmpty(var0) && !Strings.isEmpty(var1)) {
         ...
         try {
            ...
            var2 = var3.getMethod(var1, new Class[0]);
         ...
         if(var3 == DataSource.class) {
            try {
               var5 = (DataSource)var2.invoke((Object)null, new Object[0]);
               var4 = var4 + "[" + var5 + "]";
            ...
            if(var3 != Connection.class) {
               LOGGER.error("Method [{}.{}()] returns unsupported type [{}].", new Object[]{var0, var1, var3.getName()});
               return null;
            }
            ...
            var5 = new DataSource() {
               public Connection getConnection() throws SQLException {
                  try {
                     return (Connection)var2.invoke((Object)null, new Object[0]);
