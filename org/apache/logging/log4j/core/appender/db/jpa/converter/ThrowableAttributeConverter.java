...
public class ThrowableAttributeConverter implements AttributeConverter<Throwable, String> {
         ...
         for(int var7 = 0; var7 < var6; ++var7) {
            ...
            if(var9.length == 2) {
               if(String.class == var9[0] && Throwable.class.isAssignableFrom(var9[1])) {
                  return (Throwable)var8.newInstance(new Object[]{var2, var3});
               }

               if(String.class == var9[1] && Throwable.class.isAssignableFrom(var9[0])) {
                  return (Throwable)var8.newInstance(new Object[]{var3, var2});
               }
            }
         }
      ...
      try {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            if(var8.length == 1 && Throwable.class.isAssignableFrom(var8[0])) {
               return (Throwable)var7.newInstance(new Object[]{var2});
            }
         }
   ...
   private Throwable getThrowable(Class<Throwable> var1, String var2) {
      try {
         return (Throwable)var1.getConstructor(new Class[]{String.class}).newInstance(new Object[]{var2});
   ...
   public Object convertToDatabaseColumn(Object var1) {
      return this.convertToDatabaseColumn((Throwable)var1);
   }
