...
public interface X11 extends Library {
   ...
   static default {
      XA_LAST_PREDEFINED = XA_WM_TRANSIENT_FOR;
   }
   ...
   public static class XClientMessageEvent extends Structure {
      ...
      public int format;
      public X11.XClientMessageEvent.XClientMessageEvent$Data data;

      public XClientMessageEvent() {
      }

      public static class XClientMessageEvent$Data extends Union {
         public byte[] b = new byte[20];
         public short[] s = new short[10];
         public NativeLong[] l = new NativeLong[5];

         public XClientMessageEvent$Data() {
         }
      }
   }
   ...
   public static class XRectangle extends Structure {
      ...
      public XRectangle(short var1, short var2, short var3, short var4) {
         this.x = var1;
         this.y = var2;
         this.width = var3;
         this.height = var4;
   ...
   public static class XPoint extends Structure {
      ...
      public XPoint(short var1, short var2) {
         this.x = var1;
         this.y = var2;
      }
   }
   ...
   public static class XSizeHints extends Structure {
      ...
      public X11.XSizeHints.XSizeHints$Aspect min_aspect;
      public X11.XSizeHints.XSizeHints$Aspect max_aspect;
      ...
      public static class XSizeHints$Aspect extends Structure {
         public int x;
         public int y;

         public XSizeHints$Aspect() {
         }
      }
   }
   ...
   public interface Xrender extends Library {
      ...
      X11.Xrender.Xrender$XRenderPictFormat XRenderFindVisualFormat(X11.Display var1, X11.Visual var2);

      public static class Xrender$XRenderPictFormat extends Structure {
         public X11.Xrender.Xrender$PictFormat id;
         public int type;
         public int depth;
         public X11.Xrender.Xrender$XRenderDirectFormat direct;
         public X11.Colormap colormap;

         public Xrender$XRenderPictFormat() {
         }
      }

      public static class Xrender$PictFormat extends NativeLong {
         private static final long serialVersionUID = 1L;

         public Xrender$PictFormat(long var1) {
            super(var1);
         }

         public Xrender$PictFormat() {
         }
      }

      public static class Xrender$XRenderDirectFormat extends Structure {
         public short red;
         ...
         public Xrender$XRenderDirectFormat() {
         }
      }
   }
   ...
   public static class Pixmap extends X11.Drawable {
      ...
      public Pixmap(long var1) {
         super(var1);
      }

      public Object fromNative(Object var1, FromNativeContext var2) {
         return this.isNone(var1)?None:new X11.Pixmap(((Number)var1).longValue());
      }
   }
   ...
   public static class WindowByReference extends ByReference {
      ...
      public X11.Window getValue() {
         NativeLong var1 = this.getPointer().getNativeLong(0L);
         return var1.longValue() == 0L?X11.Window.None:new X11.Window(var1.longValue());
      }
   }
   ...
   public static class Window extends X11.Drawable {
      ...
      public Window(long var1) {
         super(var1);
      }

      public Object fromNative(Object var1, FromNativeContext var2) {
         return this.isNone(var1)?None:new X11.Window(((Number)var1).longValue());
      }
   }
   ...
   public static class Drawable extends X11.XID {
      ...
      public Drawable(long var1) {
         super(var1);
      }

      public Object fromNative(Object var1, FromNativeContext var2) {
         return this.isNone(var1)?None:new X11.Drawable(((Number)var1).longValue());
      }
   }
   ...
   public static class KeySym extends X11.XID {
      ...
      public KeySym(long var1) {
         super(var1);
      }

      public Object fromNative(Object var1, FromNativeContext var2) {
         return this.isNone(var1)?None:new X11.KeySym(((Number)var1).longValue());
      }
   }
   ...
   public static class Cursor extends X11.XID {
      ...
      public Cursor(long var1) {
         super(var1);
      }

      public Object fromNative(Object var1, FromNativeContext var2) {
         return this.isNone(var1)?None:new X11.Cursor(((Number)var1).longValue());
      }
   }
   ...
   public static class Font extends X11.XID {
      ...
      public Object fromNative(Object var1, FromNativeContext var2) {
         return this.isNone(var1)?None:new X11.Font(((Number)var1).longValue());
      }
   }
   ...
   public static class Colormap extends X11.XID {
      ...
      public Colormap(long var1) {
         super(var1);
      }

      public Object fromNative(Object var1, FromNativeContext var2) {
         return this.isNone(var1)?None:new X11.Colormap(((Number)var1).longValue());
      }
   }
   ...
   public static class AtomByReference extends ByReference {
      ...
      public X11.Atom getValue() {
         NativeLong var1 = this.getPointer().getNativeLong(0L);
         return (X11.Atom)(new X11.Atom()).fromNative(var1, (FromNativeContext)null);
      }
   }
   ...
   public static class Atom extends X11.XID {
      ...
      public Atom(long var1) {
         super(var1);
      }

      public Object fromNative(Object var1, FromNativeContext var2) {
         long var3 = ((Number)var1).longValue();
         if(var3 <= 2147483647L) {
            switch((int)var3) {
            case 0:
               return None;
   ...
   public static class XID extends NativeLong {
      ...
      public XID(long var1) {
         super(var1);
      }

      protected boolean isNone(Object var1) {
         return var1 == null || var1 instanceof Number && ((Number)var1).longValue() == 0L;
      }

      public Object fromNative(Object var1, FromNativeContext var2) {
         return this.isNone(var1)?None:new X11.XID(((Number)var1).longValue());
      }
