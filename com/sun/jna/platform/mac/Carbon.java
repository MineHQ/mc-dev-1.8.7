...
public interface Carbon {
   ...
   int RegisterEventHotKey(int var1, int var2, Carbon.EventHotKeyID.EventHotKeyID$ByValue var3, Pointer var4, int var5, PointerByReference var6);
   ...
   public static class EventHotKeyID extends Structure {
      ...
      public static class EventHotKeyID$ByValue extends Carbon.EventHotKeyID implements Structure.ByValue {
         public EventHotKeyID$ByValue() {
         }
      }
   }
