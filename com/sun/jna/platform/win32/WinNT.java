...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD {
   ...
   boolean CreateProcess(String var1, String var2, WinBase.SECURITY_ATTRIBUTES var3, WinBase.SECURITY_ATTRIBUTES var4, boolean var5, WinDef.DWORD var6, Pointer var7, String var8, WinBase.STARTUPINFO var9, WinBase.PROCESS_INFORMATION.PROCESS_INFORMATION$ByReference var10);
   ...
   boolean GetFileTime(WinNT.HANDLE var1, WinBase.FILETIME.FILETIME$ByReference var2, WinBase.FILETIME.FILETIME$ByReference var3, WinBase.FILETIME.FILETIME$ByReference var4);
   ...
   boolean GetDiskFreeSpaceEx(String var1, WinNT.LARGE_INTEGER.LARGE_INTEGER$ByReference var2, WinNT.LARGE_INTEGER.LARGE_INTEGER$ByReference var3, WinNT.LARGE_INTEGER.LARGE_INTEGER$ByReference var4);
   ...
   boolean Process32First(WinNT.HANDLE var1, Tlhelp32.PROCESSENTRY32.PROCESSENTRY32$ByReference var2);

   boolean Process32Next(WinNT.HANDLE var1, Tlhelp32.PROCESSENTRY32.PROCESSENTRY32$ByReference var2);
   ...
   public static class ACCESS_DENIED_ACE extends WinNT.ACCESS_ACEStructure {
      public ACCESS_DENIED_ACE(Pointer var1) {
         super(var1);
      }
   }

   public static class ACCESS_ALLOWED_ACE extends WinNT.ACCESS_ACEStructure {
      public ACCESS_ALLOWED_ACE(Pointer var1) {
         super(var1);
      }
   }
   ...
   public abstract static class ACCESS_ACEStructure extends WinNT.ACEStructure {
      ...
      public ACCESS_ACEStructure(Pointer var1) {
         super(var1);
         this.read();
         int var2 = super.AceSize - this.size() + 4;
         byte var3 = 8;
         byte[] var4 = var1.getByteArray((long)var3, var2);
         this.psid = new WinNT.PSID(var4);
      }
   }

   public static class ACE_HEADER extends WinNT.ACEStructure {
      public ACE_HEADER(Pointer var1) {
         super(var1);
         this.read();
      }
   }
   ...
   public abstract static class ACEStructure extends Structure {
      ...
      public ACEStructure(Pointer var1) {
         super(var1);
      }
   ...
   public static class SECURITY_DESCRIPTOR_RELATIVE extends Structure {
      ...
      public SECURITY_DESCRIPTOR_RELATIVE(byte[] var1) {
         super((Pointer)(new Memory((long)var1.length)));
         this.getPointer().write(0L, (byte[])var1, 0, var1.length);
         this.setDacl();
      }

      public SECURITY_DESCRIPTOR_RELATIVE(Memory var1) {
         super((Pointer)var1);
         this.setDacl();
      }
      ...
      public static class SECURITY_DESCRIPTOR_RELATIVE$ByReference extends WinNT.SECURITY_DESCRIPTOR_RELATIVE implements Structure.ByReference {
         public SECURITY_DESCRIPTOR_RELATIVE$ByReference() {
         }
      }
   }
   ...
   public static class ACL extends Structure {
      ...
      public ACL(Pointer var1) {
         super(var1);
         this.read();
         this.ACEs = new WinNT.ACCESS_ACEStructure[this.AceCount];
         int var2 = this.size();

         for(int var3 = 0; var3 < this.AceCount; ++var3) {
            Pointer var4 = var1.share((long)var2);
            byte var5 = var4.getByte(0L);
            Object var6 = null;
            switch(var5) {
            case 0:
               var6 = new WinNT.ACCESS_ALLOWED_ACE(var4);
               break;
            case 1:
               var6 = new WinNT.ACCESS_DENIED_ACE(var4);
               break;
            default:
               throw new IllegalArgumentException("Unknwon ACE type " + var5);
            }

            this.ACEs[var3] = (WinNT.ACCESS_ACEStructure)var6;
            var2 += ((WinNT.ACCESS_ACEStructure)var6).AceSize;
         }
   ...
   public static class SECURITY_DESCRIPTOR extends Structure {
      ...
      public SECURITY_DESCRIPTOR(byte[] var1) {
         this.data = var1;
         this.useMemory(new Memory((long)var1.length));
      }

      public SECURITY_DESCRIPTOR(Pointer var1) {
         super(var1);
      }

      public static class SECURITY_DESCRIPTOR$ByReference extends WinNT.SECURITY_DESCRIPTOR implements Structure.ByReference {
         public SECURITY_DESCRIPTOR$ByReference() {
         }
      }
   }
   ...
   public static class OSVERSIONINFOEX extends Structure {
      ...
      public OSVERSIONINFOEX(Pointer var1) {
         this.useMemory(var1);
         this.read();
      }
   }
   ...
   public static class OSVERSIONINFO extends Structure {
      ...
      public OSVERSIONINFO(Pointer var1) {
         this.useMemory(var1);
         this.read();
      }
   }
   ...
   public static class HANDLEByReference extends com.sun.jna.ptr.ByReference {
      ...
      public HANDLEByReference(WinNT.HANDLE var1) {
         super(Pointer.SIZE);
         this.setValue(var1);
      }

      public void setValue(WinNT.HANDLE var1) {
      ...
      public WinNT.HANDLE getValue() {
         ...
         if(var1 == null) {
            ...
            WinNT.HANDLE var2 = new WinNT.HANDLE();
   ...
   public static class HANDLE extends PointerType {
      ...
      public HANDLE(Pointer var1) {
         this.setPointer(var1);
         this.immutable = true;
      }

      public Object fromNative(Object var1, FromNativeContext var2) {
         Object var3 = super.fromNative(var1, var2);
         return WinBase.INVALID_HANDLE_VALUE.equals(var3)?WinBase.INVALID_HANDLE_VALUE:var3;
      }
      ...
      public void setPointer(Pointer var1) {
         if(this.immutable) {
            ...
            super.setPointer(var1);
         }
      }
   }

   public static class LARGE_INTEGER extends Structure {
      public WinNT.LARGE_INTEGER.LARGE_INTEGER$UNION u;
      ...
      public static class LARGE_INTEGER$UNION extends Union {
         public WinNT.LARGE_INTEGER.LARGE_INTEGER$LowHigh lh;
         public long value;

         public LARGE_INTEGER$UNION() {
         }
      }

      public static class LARGE_INTEGER$LowHigh extends Structure {
         public WinDef.DWORD LowPart;
         public WinDef.DWORD HighPart;

         public LARGE_INTEGER$LowHigh() {
         }
      }

      public static class LARGE_INTEGER$ByReference extends WinNT.LARGE_INTEGER implements Structure.ByReference {
         public LARGE_INTEGER$ByReference() {
         }
      }
   }
   ...
   public static class FILE_NOTIFY_INFORMATION extends Structure {
      ...
      public FILE_NOTIFY_INFORMATION(int var1) {
         if(var1 < this.size()) {
            throw new IllegalArgumentException("Size must greater than " + this.size() + ", requested " + var1);
         } else {
      ...
      public WinNT.FILE_NOTIFY_INFORMATION next() {
         if(this.NextEntryOffset == 0) {
            ...
            WinNT.FILE_NOTIFY_INFORMATION var1 = new WinNT.FILE_NOTIFY_INFORMATION();
            var1.useMemory(this.getPointer(), this.NextEntryOffset);
            var1.read();
            return var1;
         }
      }
   ...
   public static class TOKEN_PRIVILEGES extends Structure {
      ...
      public TOKEN_PRIVILEGES(int var1) {
         this.PrivilegeCount = new WinDef.DWORD((long)var1);
         this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[var1];
      }
   }
   ...
   public static class TOKEN_GROUPS extends Structure {
      ...
      public TOKEN_GROUPS(Pointer var1) {
         super(var1);
         this.read();
      }

      public TOKEN_GROUPS(int var1) {
         super((Pointer)(new Memory((long)var1)));
      }
   ...
   public static class TOKEN_USER extends Structure {
      ...
      public TOKEN_USER(Pointer var1) {
         super(var1);
         this.read();
      }

      public TOKEN_USER(int var1) {
         super((Pointer)(new Memory((long)var1)));
      }
   }
   ...
   public static class PSIDByReference extends com.sun.jna.ptr.ByReference {
      ...
      public PSIDByReference(WinNT.PSID var1) {
         super(Pointer.SIZE);
         this.setValue(var1);
      }

      public void setValue(WinNT.PSID var1) {
         this.getPointer().setPointer(0L, var1 != null?var1.getPointer():null);
      }

      public WinNT.PSID getValue() {
         Pointer var1 = this.getPointer().getPointer(0L);
         return var1 == null?null:new WinNT.PSID(var1);
      }
   }
   ...
   public static class PSID extends Structure {
      ...
      public PSID(byte[] var1) {
         super((Pointer)(new Memory((long)var1.length)));
         this.getPointer().write(0L, (byte[])var1, 0, var1.length);
         this.read();
      }

      public PSID(int var1) {
         super((Pointer)(new Memory((long)var1)));
      }

      public PSID(Pointer var1) {
         super(var1);
         this.read();
      }

      public byte[] getBytes() {
         int var1 = Advapi32.INSTANCE.GetLengthSid(this);
         return this.getPointer().getByteArray(0L, var1);
      }

      public static class PSID$ByReference extends WinNT.PSID implements Structure.ByReference {
         public PSID$ByReference() {
         }
      }
   }

   public static class TOKEN_OWNER extends Structure {
      public WinNT.PSID.PSID$ByReference Owner;

      public TOKEN_OWNER() {
      }

      public TOKEN_OWNER(int var1) {
         super((Pointer)(new Memory((long)var1)));
      }

      public TOKEN_OWNER(Pointer var1) {
         super(var1);
         this.read();
      }
   }
   ...
   public static class SID_AND_ATTRIBUTES extends Structure {
      ...
      public SID_AND_ATTRIBUTES(Pointer var1) {
         super(var1);
      }
   }
   ...
   public static class LUID_AND_ATTRIBUTES extends Structure {
      ...
      public LUID_AND_ATTRIBUTES(WinNT.LUID var1, WinDef.DWORD var2) {
         this.Luid = var1;
