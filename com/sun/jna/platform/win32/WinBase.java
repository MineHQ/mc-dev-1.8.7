...
public interface WinBase extends StdCallLibrary, WinDef, BaseTSD {
   ...
   public static class PROCESS_INFORMATION extends Structure {
      ...
      public PROCESS_INFORMATION(Pointer var1) {
         super(var1);
         this.read();
      }

      public static class PROCESS_INFORMATION$ByReference extends WinBase.PROCESS_INFORMATION implements Structure.ByReference {
         public PROCESS_INFORMATION$ByReference() {
         }

         public PROCESS_INFORMATION$ByReference(Pointer var1) {
            super(var1);
         }
      }
   }
   ...
   public static class SYSTEM_INFO extends Structure {
      public WinBase.SYSTEM_INFO.SYSTEM_INFO$UNION processorArchitecture;
      ...
      public static class SYSTEM_INFO$UNION extends Union {
         public WinDef.DWORD dwOemID;
         public WinBase.SYSTEM_INFO.SYSTEM_INFO$PI pi;

         public SYSTEM_INFO$UNION() {
         }

         public static class SYSTEM_INFO$UNION$ByReference extends WinBase.SYSTEM_INFO.SYSTEM_INFO$UNION implements Structure.ByReference {
            public SYSTEM_INFO$UNION$ByReference() {
            }
         }
      }

      public static class SYSTEM_INFO$PI extends Structure {
         public WinDef.WORD wProcessorArchitecture;
         public WinDef.WORD wReserved;

         public SYSTEM_INFO$PI() {
         }

         public static class SYSTEM_INFO$PI$ByReference extends WinBase.SYSTEM_INFO.SYSTEM_INFO$PI implements Structure.ByReference {
            public SYSTEM_INFO$PI$ByReference() {
            }
         }
      }
   }
   ...
   public static class FILETIME extends Structure {
      ...
      public FILETIME(Date var1) {
         long var2 = dateToFileTime(var1);
         this.dwHighDateTime = (int)(var2 >> 32 & 4294967295L);
         this.dwLowDateTime = (int)(var2 & 4294967295L);
      }

      public FILETIME() {
      }

      public FILETIME(Pointer var1) {
         super(var1);
         this.read();
      }

      public static Date filetimeToDate(int var0, int var1) {
         long var2 = (long)var0 << 32 | (long)var1 & 4294967295L;
         long var4 = var2 / 10000L;
         long var6 = var4 - 11644473600000L;
         return new Date(var6);
      }

      public static long dateToFileTime(Date var0) {
         long var1 = var0.getTime();
         long var3 = var1 + 11644473600000L;
         return var3 * 1000L * 10L;
      }
      ...
      public static class FILETIME$ByReference extends WinBase.FILETIME implements Structure.ByReference {
         public FILETIME$ByReference() {
         }

         public FILETIME$ByReference(Pointer var1) {
            super(var1);
         }
      }
   }
