...
public interface Netapi32 extends StdCallLibrary {
   ...
   int DsGetDcName(String var1, String var2, Guid.GUID var3, String var4, int var5, DsGetDC.PDOMAIN_CONTROLLER_INFO.PDOMAIN_CONTROLLER_INFO$ByReference var6);

   int DsGetForestTrustInformation(String var1, String var2, int var3, NTSecApi.PLSA_FOREST_TRUST_INFORMATION.PLSA_FOREST_TRUST_INFORMATION$ByReference var4);

   int DsEnumerateDomainTrusts(String var1, NativeLong var2, DsGetDC.PDS_DOMAIN_TRUSTS.PDS_DOMAIN_TRUSTS$ByReference var3, NativeLongByReference var4);

   int NetUserGetInfo(String var1, String var2, int var3, PointerByReference var4);

   static default {
      INSTANCE = (Netapi32)Native.loadLibrary("Netapi32", Netapi32.class, W32APIOptions.UNICODE_OPTIONS);
   }
}
