...
public interface VerRsrc extends StdCallLibrary {
   public static class VS_FIXEDFILEINFO extends Structure {
      ...
      public VS_FIXEDFILEINFO(Pointer var1) {
         super(var1);
         this.read();
      }

      public static class VS_FIXEDFILEINFO$ByReference extends VerRsrc.VS_FIXEDFILEINFO implements Structure.ByReference {
         public VS_FIXEDFILEINFO$ByReference() {
         }

         public VS_FIXEDFILEINFO$ByReference(Pointer var1) {
            super(var1);
         }
      }
   }
