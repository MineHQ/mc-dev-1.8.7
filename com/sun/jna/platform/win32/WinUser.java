...
public interface WinUser extends StdCallLibrary, WinDef {
   ...
   public static class MOUSEINPUT extends Structure {
      ...
      public MOUSEINPUT(Pointer var1) {
         super(var1);
         this.read();
      }

      public static class MOUSEINPUT$ByReference extends WinUser.MOUSEINPUT implements Structure.ByReference {
         public MOUSEINPUT$ByReference() {
         }

         public MOUSEINPUT$ByReference(Pointer var1) {
            super(var1);
         }
      }
   }
   ...
   public static class KEYBDINPUT extends Structure {
      ...
      public KEYBDINPUT(Pointer var1) {
         super(var1);
         this.read();
      }

      public static class KEYBDINPUT$ByReference extends WinUser.KEYBDINPUT implements Structure.ByReference {
         public KEYBDINPUT$ByReference() {
         }

         public KEYBDINPUT$ByReference(Pointer var1) {
            super(var1);
         }
      }
   }
   ...
   public static class INPUT extends Structure {
      ...
      public WinUser.INPUT.INPUT$INPUT_UNION input = new WinUser.INPUT.INPUT$INPUT_UNION();

      public INPUT() {
      }

      public INPUT(Pointer var1) {
         super(var1);
         this.read();
      }

      public static class INPUT$INPUT_UNION extends Union {
         public WinUser.MOUSEINPUT mi;
         public WinUser.KEYBDINPUT ki;
         public WinUser.HARDWAREINPUT hi;

         public INPUT$INPUT_UNION() {
         }

         public INPUT$INPUT_UNION(Pointer var1) {
            super(var1);
            this.read();
         }
      }

      public static class INPUT$ByReference extends WinUser.INPUT implements Structure.ByReference {
         public INPUT$ByReference() {
         }

         public INPUT$ByReference(Pointer var1) {
            super(var1);
         }
      }
   }
   ...
   public static class HARDWAREINPUT extends Structure {
      ...
      public HARDWAREINPUT(Pointer var1) {
         super(var1);
         this.read();
      }

      public static class HARDWAREINPUT$ByReference extends WinUser.HARDWAREINPUT implements Structure.ByReference {
         public HARDWAREINPUT$ByReference() {
         }

         public HARDWAREINPUT$ByReference(Pointer var1) {
            super(var1);
         }
      }
   }
