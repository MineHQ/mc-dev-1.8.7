...
public interface Winspool extends StdCallLibrary {
   ...
   static default {
      INSTANCE = (Winspool)Native.loadLibrary("Winspool.drv", Winspool.class, W32APIOptions.UNICODE_OPTIONS);
   }
   ...
   public static class PRINTER_INFO_4 extends Structure {
      ...
      public PRINTER_INFO_4(int var1) {
   ...
   public static class PRINTER_INFO_1 extends Structure {
      ...
      public PRINTER_INFO_1(int var1) {
         super((Pointer)(new Memory((long)var1)));
      }
   }
}
