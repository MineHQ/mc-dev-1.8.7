...
public final class Predicates {
   ...
   public static <T> Predicate<T> or(Predicate... var0) {
   ...
   private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
      ...
      // $FF: synthetic method
      CompositionPredicate(Predicate var1, Function var2, Predicates.SyntheticClass_1 var3) {
         this(var1, var2);
      }
   }
   ...
   private static class InPredicate<T> implements Predicate<T>, Serializable {
      ...
      // $FF: synthetic method
      InPredicate(Collection var1, Predicates.SyntheticClass_1 var2) {
         this(var1);
      }
   }
   ...
   private static class AssignableFromPredicate implements Predicate<Class<?>>, Serializable {
      ...
      // $FF: synthetic method
      AssignableFromPredicate(Class var1, Predicates.SyntheticClass_1 var2) {
         this(var1);
      }
   }
   ...
   private static class InstanceOfPredicate implements Predicate<Object>, Serializable {
      ...
      // $FF: synthetic method
      InstanceOfPredicate(Class var1, Predicates.SyntheticClass_1 var2) {
         this(var1);
      }
   }
   ...
   private static class IsEqualToPredicate<T> implements Predicate<T>, Serializable {
      ...
      // $FF: synthetic method
      IsEqualToPredicate(Object var1, Predicates.SyntheticClass_1 var2) {
         this(var1);
      }
   }
   ...
   private static class OrPredicate<T> implements Predicate<T>, Serializable {
      ...
      // $FF: synthetic method
      OrPredicate(List var1, Predicates.SyntheticClass_1 var2) {
         this(var1);
      }
   }
   ...
   private static class AndPredicate<T> implements Predicate<T>, Serializable {
      ...
      // $FF: synthetic method
      AndPredicate(List var1, Predicates.SyntheticClass_1 var2) {
         this(var1);
      }
   }
   ...
   static enum ObjectPredicate implements Predicate<Object> {
      ...
      // $FF: synthetic method
      ObjectPredicate(Predicates.SyntheticClass_1 var3) {
         this();
      }
   }
}
