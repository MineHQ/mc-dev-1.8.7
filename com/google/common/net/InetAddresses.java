...
public final class InetAddresses {
   ...
   private static Inet4Address getInet4Address(byte[] var0) {
      Preconditions.checkArgument(var0.length == 4, "Byte array has invalid length for an IPv4 address: %s != 4.", new Object[]{Integer.valueOf(var0.length)});
   ...
   public static InetAddress forString(String var0) {
      ...
      if(var1 == null) {
         throw new IllegalArgumentException(String.format("\'%s\' is not an IP string literal.", new Object[]{var0}));
      } else {
      ...
      if(var1.length != 4) {
         ...
         try {
            for(int var3 = 0; var3 < var2.length; ++var3) {
               var2[var3] = parseOctet(var1[var3]);
            }
   ...
   public static InetAddress forUriString(String var0) {
      ...
      if(var3 != null && var3.length == var2) {
         return bytesToInetAddress(var3);
      } else {
         throw new IllegalArgumentException(String.format("Not a valid URI IP literal: \'%s\'", new Object[]{var0}));
      }
   }
   ...
   public static Inet4Address getCompatIPv4Address(Inet6Address var0) {
      Preconditions.checkArgument(isCompatIPv4Address(var0), "Address \'%s\' is not IPv4-compatible.", new Object[]{toAddrString(var0)});
   ...
   public static Inet4Address get6to4IPv4Address(Inet6Address var0) {
      Preconditions.checkArgument(is6to4Address(var0), "Address \'%s\' is not a 6to4 address.", new Object[]{toAddrString(var0)});
   ...
   public static InetAddresses.TeredoInfo getTeredoInfo(Inet6Address var0) {
      Preconditions.checkArgument(isTeredoAddress(var0), "Address \'%s\' is not a Teredo address.", new Object[]{toAddrString(var0)});
      byte[] var1 = var0.getAddress();
   ...
   public static Inet4Address getIsatapIPv4Address(Inet6Address var0) {
      Preconditions.checkArgument(isIsatapAddress(var0), "Address \'%s\' is not an ISATAP address.", new Object[]{toAddrString(var0)});
      return getInet4Address(Arrays.copyOfRange(var0.getAddress(), 12, 16));
   }
   ...
   public static Inet4Address getEmbeddedIPv4ClientAddress(Inet6Address var0) {
      if(isCompatIPv4Address(var0)) {
         ...
         throw new IllegalArgumentException(String.format("\'%s\' has no embedded IPv4 address.", new Object[]{toAddrString(var0)}));
      }
   }
   ...
   public static InetAddress increment(InetAddress var0) {
      ...
      Preconditions.checkArgument(var2 >= 0, "Incrementing %s would wrap.", new Object[]{var0});
      ++var1[var2];
      return bytesToInetAddress(var1);
   }
   ...
   public static final class TeredoInfo {
      ...
      public TeredoInfo(@Nullable Inet4Address var1, @Nullable Inet4Address var2, int var3, int var4) {
         Preconditions.checkArgument(var3 >= 0 && var3 <= '\uffff', "port \'%s\' is out of range (0 <= port <= 0xffff)", new Object[]{Integer.valueOf(var3)});
         Preconditions.checkArgument(var4 >= 0 && var4 <= '\uffff', "flags \'%s\' is out of range (0 <= flags <= 0xffff)", new Object[]{Integer.valueOf(var4)});
         this.server = (Inet4Address)Objects.firstNonNull(var1, InetAddresses.ANY4);
         this.client = (Inet4Address)Objects.firstNonNull(var2, InetAddresses.ANY4);
         this.port = var3;
         this.flags = var4;
      }
