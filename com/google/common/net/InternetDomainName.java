...
public final class InternetDomainName {
   ...
   InternetDomainName(String var1) {
      ...
      Preconditions.checkArgument(var1.length() <= 253, "Domain name too long: \'%s\':", new Object[]{var1});
      this.name = var1;
      this.parts = ImmutableList.copyOf(DOT_SPLITTER.split(var1));
      Preconditions.checkArgument(this.parts.size() <= 127, "Domain has too many parts: \'%s\'", new Object[]{var1});
      Preconditions.checkArgument(validateSyntax(this.parts), "Not a valid domain name: \'%s\'", new Object[]{var1});
   ...
   private static boolean validatePart(String var0, boolean var1) {
      if(var0.length() >= 1 && var0.length() <= 63) {
         ...
         return !PART_CHAR_MATCHER.matchesAllOf(var2)?false:(!DASH_MATCHER.matches(var0.charAt(0)) && !DASH_MATCHER.matches(var0.charAt(var0.length() - 1))?!var1 || !CharMatcher.DIGIT.matches(var0.charAt(0)):false);
      } else {
         return false;
      }
   }
