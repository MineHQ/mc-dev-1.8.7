...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
   ...
   ImmutableSortedSet<E> getSubSet(int var1, int var2) {
      return (ImmutableSortedSet)(var1 == 0 && var2 == this.size()?this:(var1 < var2?new RegularImmutableSortedSet(this.elements.subList(var1, var2), this.comparator):emptySet(this.comparator)));
   }
