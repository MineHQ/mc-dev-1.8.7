...
public final class Iterators {
   ...
   public static <T> UnmodifiableIterator<T> unmodifiableIterator(final Iterator<T> var0) {
      Preconditions.checkNotNull(var0);
      return var0 instanceof UnmodifiableIterator?(UnmodifiableIterator)var0:new UnmodifiableIterator() {
         public boolean hasNext() {
            return var0.hasNext();
         }
   ...
   public static <T> Iterator<T> cycle(final Iterable<T> var0) {
      ...
      return new Iterator() {
         ...
         {
            this.iterator = Iterators.EMPTY_LIST_ITERATOR;
         }
   ...
   public static <T> Iterator<T> concat(Iterator... var0) {
      return concat((Iterator)ImmutableList.copyOf((Object[])var0).iterator());
   }

   public static <T> Iterator<T> concat(final Iterator<? extends Iterator<? extends T>> var0) {
      Preconditions.checkNotNull(var0);
      return new Iterator() {
         ...
         {
            this.current = Iterators.EMPTY_LIST_ITERATOR;
         }

         public boolean hasNext() {
            boolean var1;
            while(!(var1 = ((Iterator)Preconditions.checkNotNull(this.current)).hasNext()) && var0.hasNext()) {
               this.current = (Iterator)var0.next();
            }
   ...
   public static <F, T> Iterator<T> transform(final Iterator<F> var0, final Function<? super F, ? extends T> var1) {
      Preconditions.checkNotNull(var1);
      return new TransformedIterator(var0) {
         T transform(F var1x) {
   ...
   static <T> UnmodifiableListIterator<T> forArray(final T[] var0, final int var1, final int var2, final int var3) {
      ...
      return (UnmodifiableListIterator)(var2 == 0?emptyListIterator():new AbstractIndexedListIterator(var2, var3) {
      ...
      public MergingIterator(Iterable<? extends Iterator<? extends T>> var1, final Comparator<? super T> var2) {
         Comparator var3 = new Comparator() {
            ...
            public int compare(Object var1, Object var2x) {
               return this.compare((PeekingIterator)var1, (PeekingIterator)var2x);
            }
         };
