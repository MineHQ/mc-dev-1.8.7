...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
   ...
   private class ColumnMap extends Maps.ImprovedAbstractMap<C, Map<R, V>> {
      ...
      public Set<Entry<C, Map<R, V>>> createEntrySet() {
         return new StandardTable.ColumnMap.ColumnMap$ColumnMapEntrySet();
      }
      ...
      Collection<Map<R, V>> createValues() {
         return new StandardTable.ColumnMap.ColumnMap$ColumnMapValues();
      }
      ...
      // $FF: synthetic method
      ColumnMap(StandardTable.SyntheticClass_1 var2) {
         this();
      }

      private class ColumnMap$ColumnMapValues extends Maps.Values<C, Map<R, V>> {
      ...
      class ColumnMap$ColumnMapEntrySet extends StandardTable<R, C, V>.TableSet<Entry<C, Map<R, V>>> {
   ...
   class RowMap extends Maps.ImprovedAbstractMap<R, Map<C, V>> {
      ...
      protected Set<Entry<R, Map<C, V>>> createEntrySet() {
         return new StandardTable.RowMap.RowMap$EntrySet();
      }
      ...
      class RowMap$EntrySet extends StandardTable<R, C, V>.TableSet<Entry<R, Map<C, V>>> {
         RowMap$EntrySet() {
            super();
         }
   ...
   private class ColumnKeyIterator extends AbstractIterator<C> {
      ...
      // $FF: synthetic method
      ColumnKeyIterator(StandardTable.SyntheticClass_1 var2) {
         this();
      }
   }
   ...
   private class ColumnKeySet extends StandardTable<R, C, V>.TableSet<C> {
      ...
      // $FF: synthetic method
      ColumnKeySet(StandardTable.SyntheticClass_1 var2) {
         this();
      }
   }
   ...
   private class Column extends Maps.ImprovedAbstractMap<R, V> {
      ...
      Set<Entry<R, V>> createEntrySet() {
         return new StandardTable.Column.Column$EntrySet();
      }

      Set<R> createKeySet() {
         return new StandardTable.Column.Column$KeySet();
      }

      Collection<V> createValues() {
         return new StandardTable.Column.Column$Values();
      }

      private class Column$Values extends Maps.Values<R, V> {
         Column$Values() {
            super(Column.this);
         }
      ...
      private class Column$KeySet extends Maps.KeySet<R, V> {
         Column$KeySet() {
            super(Column.this);
         }
      ...
      private class Column$EntrySetIterator extends AbstractIterator<Entry<R, V>> {
         ...
         // $FF: synthetic method
         Column$EntrySetIterator(StandardTable.SyntheticClass_1 var2) {
            this();
         }
      }

      private class Column$EntrySet extends Sets.ImprovedAbstractSet<Entry<R, V>> {
         private Column$EntrySet() {
         }

         public Iterator<Entry<R, V>> iterator() {
            return Column.this.new Column$EntrySetIterator();
         }
         ...
         // $FF: synthetic method
         Column$EntrySet(StandardTable.SyntheticClass_1 var2) {
            this();
         }
      }
   }
   ...
   class Row extends Maps.ImprovedAbstractMap<C, V> {
      ...
      protected Set<Entry<C, V>> createEntrySet() {
         return new StandardTable.Row.Row$RowEntrySet();
      }

      private final class Row$RowEntrySet extends Maps.EntrySet<C, V> {
         ...
         public int size() {
            Map var1 = Row.this.backingRowMap();
            ...
            if(var1 == null) {
               ...
               return new Iterator() {
                  ...
                  public Entry<C, V> next() {
                     final Entry var1 = (Entry)var2.next();
         ...
         // $FF: synthetic method
         Row$RowEntrySet(StandardTable.SyntheticClass_1 var2) {
            this();
         }
      }
   }
   ...
   private class CellIterator implements Iterator<Table.Cell<R, C, V>> {
      ...
      // $FF: synthetic method
      CellIterator(StandardTable.SyntheticClass_1 var2) {
         this();
      }
   }
   ...
   private abstract class TableSet<T> extends Sets.ImprovedAbstractSet<T> {
      ...
      // $FF: synthetic method
      TableSet(StandardTable.SyntheticClass_1 var2) {
         this();
      }
   }
}
