...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
   ...
   // $FF: synthetic method
   MinMaxPriorityQueue(MinMaxPriorityQueue.Builder var1, int var2, MinMaxPriorityQueue.SyntheticClass_1 var3) {
      this(var1, var2);
   }
   ...
   private class QueueIterator implements Iterator<E> {
      ...
      private boolean containsExact(Iterable<E> var1, E var2) {
      ...
      private int nextNotInSkipMe(int var1) {
         if(this.skipMe != null) {
            while(var1 < MinMaxPriorityQueue.this.size() && this.containsExact(this.skipMe, MinMaxPriorityQueue.this.elementData(var1))) {
               ++var1;
            }
         }
      ...
      // $FF: synthetic method
      QueueIterator(MinMaxPriorityQueue.SyntheticClass_1 var2) {
         this();
      }
   }
   ...
   private class Heap {
      ...
      int getCorrectLastElement(E var1) {
      ...
      private boolean verifyIndex(int var1) {
         return this.getLeftChildIndex(var1) < MinMaxPriorityQueue.this.size && this.compareElements(var1, this.getLeftChildIndex(var1)) > 0?false:(this.getRightChildIndex(var1) < MinMaxPriorityQueue.this.size && this.compareElements(var1, this.getRightChildIndex(var1)) > 0?false:(var1 > 0 && this.compareElements(var1, this.getParentIndex(var1)) > 0?false:var1 <= 2 || this.compareElements(this.getGrandparentIndex(var1), var1) <= 0));
      }
   ...
   public static final class Builder<B> {
      ...
      // $FF: synthetic method
      Builder(Comparator var1, MinMaxPriorityQueue.SyntheticClass_1 var2) {
         this(var1);
      }
   }
}
