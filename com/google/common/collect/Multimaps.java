...
public final class Multimaps {
   ...
   static final class AsMap<K, V> extends Maps.ImprovedAbstractMap<K, Collection<V>> {
      ...
      protected Set<Entry<K, Collection<V>>> createEntrySet() {
         return new Multimaps.AsMap.AsMap$EntrySet();
      }
      ...
      class AsMap$EntrySet extends Maps.EntrySet<K, Collection<V>> {
         AsMap$EntrySet() {
         }
   ...
   static class Keys<K, V> extends AbstractMultiset<K> {
      ...
      Set<Multiset.Entry<K>> createEntrySet() {
         return new Multimaps.Keys.Keys$KeysEntrySet();
      }
      ...
      class Keys$KeysEntrySet extends Multisets.EntrySet<K> {
         Keys$KeysEntrySet() {
         }
   ...
   private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
      ...
      public Map<K, Collection<V>> asMap() {
         Map var1 = this.map;
         if(var1 == null) {
            var1 = this.map = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new Function() {
