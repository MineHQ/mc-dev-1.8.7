...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
   ...
   public Map<Range<K>, V> asMapOfRanges() {
      return new TreeRangeMap.AsMapOfRanges(null);
   }
   ...
   private class SubRangeMap implements RangeMap<K, V> {
      ...
      public Map<Range<K>, V> asMapOfRanges() {
         return new TreeRangeMap.SubRangeMap.SubRangeMap$SubRangeMapAsMap();
      }
      ...
      class SubRangeMap$SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
         ...
         public Set<Range<K>> keySet() {
            return new Maps.KeySet(this) {
               public boolean remove(@Nullable Object var1) {
                  return SubRangeMap$SubRangeMapAsMap.this.remove(var1) != null;
               }

               public boolean retainAll(Collection<?> var1) {
                  return SubRangeMap$SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.not(Predicates.in(var1)), Maps.keyFunction()));
               }
            };
         }
            ...
            return new Maps.EntrySet() {
               ...
               public Iterator<Entry<Range<K>, V>> iterator() {
                  if(SubRangeMap.this.subRange.isEmpty()) {
                     ...
                     Cut var1 = (Cut)Objects.firstNonNull(TreeRangeMap.this.entriesByLowerBound.floorKey(SubRangeMap.this.subRange.lowerBound), SubRangeMap.this.subRange.lowerBound);
               ...
               public boolean retainAll(Collection<?> var1) {
                  return SubRangeMap$SubRangeMapAsMap.this.removeEntryIf(Predicates.not(Predicates.in(var1)));
               }
         ...
         public Collection<V> values() {
            return new Maps.Values(this) {
               public boolean removeAll(Collection<?> var1) {
                  return SubRangeMap$SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.in(var1), Maps.valueFunction()));
               }

               public boolean retainAll(Collection<?> var1) {
                  return SubRangeMap$SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.not(Predicates.in(var1)), Maps.valueFunction()));
               }
            };
         }
      }
