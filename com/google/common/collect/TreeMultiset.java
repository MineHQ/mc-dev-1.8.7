...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
   ...
   private long aggregateBelowRange(TreeMultiset.Aggregate var1, @Nullable TreeMultiset.AvlNode<E> var2) {
      if(var2 == null) {
         ...
         if(var3 < 0) {
            ...
            switch(TreeMultiset.SyntheticClass_1.$SwitchMap$com$google$common$collect$BoundType[this.range.getLowerBoundType().ordinal()]) {
            case 1:
   ...
   private long aggregateAboveRange(TreeMultiset.Aggregate var1, @Nullable TreeMultiset.AvlNode<E> var2) {
      if(var2 == null) {
         ...
         if(var3 > 0) {
            ...
            switch(TreeMultiset.SyntheticClass_1.$SwitchMap$com$google$common$collect$BoundType[this.range.getUpperBoundType().ordinal()]) {
            case 1:
   ...
   private static final class AvlNode<E> extends Multisets.AbstractEntry<E> {
      ...
      private TreeMultiset.AvlNode<E> ceiling(Comparator<? super E> var1, E var2) {
         int var3 = var1.compare(var2, this.elem);
         return var3 < 0?(this.left == null?this:(TreeMultiset.AvlNode)Objects.firstNonNull(this.left.ceiling(var1, var2), this)):(var3 == 0?this:(this.right == null?null:this.right.ceiling(var1, var2)));
      }

      @Nullable
      private TreeMultiset.AvlNode<E> floor(Comparator<? super E> var1, E var2) {
         int var3 = var1.compare(var2, this.elem);
         return var3 > 0?(this.right == null?this:(TreeMultiset.AvlNode)Objects.firstNonNull(this.right.floor(var1, var2), this)):(var3 == 0?this:(this.left == null?null:this.left.floor(var1, var2)));
      }
