...
final class MessageDigestHashFunction extends AbstractStreamingHashFunction implements Serializable {
   ...
   private static final class MessageDigestHasher extends AbstractByteHasher {
      ...
      // $FF: synthetic method
      MessageDigestHasher(MessageDigest var1, int var2, MessageDigestHashFunction.SyntheticClass_1 var3) {
         this(var1, var2);
      }
   }
   ...
   private static final class SerializedForm implements Serializable {
      ...
      // $FF: synthetic method
      SerializedForm(String var1, int var2, String var3, MessageDigestHashFunction.SyntheticClass_1 var4) {
         this(var1, var2, var3);
      }
   }
}
