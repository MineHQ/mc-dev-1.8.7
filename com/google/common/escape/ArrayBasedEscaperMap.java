...
public final class ArrayBasedEscaperMap {
   ...
   static char[][] createReplacementArray(Map<Character, String> var0) {
      ...
      if(var0.isEmpty()) {
         ...
         char var1 = ((Character)Collections.max(var0.keySet())).charValue();
         char[][] var2 = new char[var1 + 1][];

         char var4;
         for(Iterator var3 = var0.keySet().iterator(); var3.hasNext(); var2[var4] = ((String)var0.get(Character.valueOf(var4))).toCharArray()) {
