...
public final class Shorts {
   ...
   private static class ShortArrayAsList extends AbstractList<Short> implements RandomAccess, Serializable {
      ...
      public boolean contains(Object var1) {
         return var1 instanceof Short && Shorts.indexOf(this.array, ((Short)var1).shortValue(), this.start, this.end) != -1;
      }

      public int indexOf(Object var1) {
         if(var1 instanceof Short) {
            int var2 = Shorts.indexOf(this.array, ((Short)var1).shortValue(), this.start, this.end);
            if(var2 >= 0) {
      ...
      public int lastIndexOf(Object var1) {
         if(var1 instanceof Short) {
            int var2 = Shorts.lastIndexOf(this.array, ((Short)var1).shortValue(), this.start, this.end);
            if(var2 >= 0) {
               return var2 - this.start;
            }
         }
   ...
   private static enum LexicographicalComparator implements Comparator<short[]> {
      ...
      public int compare(Object var1, Object var2) {
         return this.compare((short[])var1, (short[])var2);
      }
   }
   ...
   private static final class ShortConverter extends Converter<String, Short> implements Serializable {
      ...
      protected Object doBackward(Object var1) {
         return this.doBackward((Short)var1);
      }
