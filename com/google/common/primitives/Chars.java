...
public final class Chars {
   ...
   private static class CharArrayAsList extends AbstractList<Character> implements RandomAccess, Serializable {
      ...
      public boolean contains(Object var1) {
         return var1 instanceof Character && Chars.indexOf(this.array, ((Character)var1).charValue(), this.start, this.end) != -1;
      }

      public int indexOf(Object var1) {
         if(var1 instanceof Character) {
            int var2 = Chars.indexOf(this.array, ((Character)var1).charValue(), this.start, this.end);
            if(var2 >= 0) {
      ...
      public int lastIndexOf(Object var1) {
         if(var1 instanceof Character) {
            int var2 = Chars.lastIndexOf(this.array, ((Character)var1).charValue(), this.start, this.end);
            if(var2 >= 0) {
               return var2 - this.start;
            }
         }
   ...
   private static enum LexicographicalComparator implements Comparator<char[]> {
      ...
      public int compare(Object var1, Object var2) {
         return this.compare((char[])var1, (char[])var2);
      }
   }
}
