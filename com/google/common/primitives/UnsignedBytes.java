...
public final class UnsignedBytes {
   ...
   static Comparator<byte[]> lexicographicalComparatorJavaImpl() {
      return UnsignedBytes.LexicographicalComparatorHolder.LexicographicalComparatorHolder$PureJavaComparator.INSTANCE;
   }
   ...
   static class LexicographicalComparatorHolder {
      ...
      static enum LexicographicalComparatorHolder$PureJavaComparator implements Comparator<byte[]> {
         INSTANCE;

         private LexicographicalComparatorHolder$PureJavaComparator() {
         }
         ...
         public int compare(Object var1, Object var2) {
            return this.compare((byte[])var1, (byte[])var2);
         }
      }

      @VisibleForTesting
      static enum LexicographicalComparatorHolder$UnsafeComparator implements Comparator<byte[]> {
         INSTANCE;
         ...
         private LexicographicalComparatorHolder$UnsafeComparator() {
         }
