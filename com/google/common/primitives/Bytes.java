...
public final class Bytes {
   ...
   private static class ByteArrayAsList extends AbstractList<Byte> implements RandomAccess, Serializable {
      ...
      public boolean contains(Object var1) {
         return var1 instanceof Byte && Bytes.indexOf(this.array, ((Byte)var1).byteValue(), this.start, this.end) != -1;
      }

      public int indexOf(Object var1) {
         if(var1 instanceof Byte) {
            int var2 = Bytes.indexOf(this.array, ((Byte)var1).byteValue(), this.start, this.end);
            if(var2 >= 0) {
      ...
      public int lastIndexOf(Object var1) {
         if(var1 instanceof Byte) {
            int var2 = Bytes.lastIndexOf(this.array, ((Byte)var1).byteValue(), this.start, this.end);
            if(var2 >= 0) {
               return var2 - this.start;
            }
         }
