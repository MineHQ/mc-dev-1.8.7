...
public final class Booleans {
   ...
   private static class BooleanArrayAsList extends AbstractList<Boolean> implements RandomAccess, Serializable {
      ...
      public boolean contains(Object var1) {
         return var1 instanceof Boolean && Booleans.indexOf(this.array, ((Boolean)var1).booleanValue(), this.start, this.end) != -1;
      }

      public int indexOf(Object var1) {
         if(var1 instanceof Boolean) {
            int var2 = Booleans.indexOf(this.array, ((Boolean)var1).booleanValue(), this.start, this.end);
            if(var2 >= 0) {
      ...
      public int lastIndexOf(Object var1) {
         if(var1 instanceof Boolean) {
            int var2 = Booleans.lastIndexOf(this.array, ((Boolean)var1).booleanValue(), this.start, this.end);
            if(var2 >= 0) {
               return var2 - this.start;
            }
         }
      ...
      public Object set(int var1, Object var2) {
         return this.set(var1, (Boolean)var2);
      }
   ...
   private static enum LexicographicalComparator implements Comparator<boolean[]> {
      ...
      public int compare(Object var1, Object var2) {
         return this.compare((boolean[])var1, (boolean[])var2);
      }
   }
}
