...
public abstract class Striped<L> {
   ...
   public static Striped<ReadWriteLock> readWriteLock(int var0) {
      return new Striped.CompactStriped(var0, READ_WRITE_LOCK_SUPPLIER, null);
   }
   ...
   static class SmallLazyStriped<L> extends Striped.PowerOfTwoStriped<L> {
      final AtomicReferenceArray<Striped.SmallLazyStriped.SmallLazyStriped$ArrayReference<? extends L>> locks;
      final Supplier<L> supplier;
      final int size;
      ...
      public L getAt(int var1) {
         ...
         Striped.SmallLazyStriped.SmallLazyStriped$ArrayReference var2 = (Striped.SmallLazyStriped.SmallLazyStriped$ArrayReference)this.locks.get(var1);
         Object var3 = var2 == null?null:var2.get();
         if(var3 != null) {
            return var3;
         } else {
            Object var4 = this.supplier.get();
            Striped.SmallLazyStriped.SmallLazyStriped$ArrayReference var5 = new Striped.SmallLazyStriped.SmallLazyStriped$ArrayReference(var4, var1, this.queue);
            ...
            do {
               ...
               var2 = (Striped.SmallLazyStriped.SmallLazyStriped$ArrayReference)this.locks.get(var1);
      ...
      private void drainQueue() {
         ...
         while((var1 = this.queue.poll()) != null) {
            Striped.SmallLazyStriped.SmallLazyStriped$ArrayReference var2 = (Striped.SmallLazyStriped.SmallLazyStriped$ArrayReference)var1;
      ...
      private static final class SmallLazyStriped$ArrayReference<L> extends WeakReference<L> {
         final int index;

         SmallLazyStriped$ArrayReference(L var1, int var2, ReferenceQueue<L> var3) {
            super(var1, var3);
            this.index = var2;
         }
      }
