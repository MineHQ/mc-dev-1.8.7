...
public class CycleDetectingLockFactory {
   ...
   public ReentrantLock newReentrantLock(String var1, boolean var2) {
      return (ReentrantLock)(this.policy == CycleDetectingLockFactory.Policies.DISABLED?new ReentrantLock(var2):new CycleDetectingLockFactory.CycleDetectingReentrantLock(new CycleDetectingLockFactory.LockGraphNode(var1), var2, null));
   }
   ...
   public ReentrantReadWriteLock newReentrantReadWriteLock(String var1, boolean var2) {
      return (ReentrantReadWriteLock)(this.policy == CycleDetectingLockFactory.Policies.DISABLED?new ReentrantReadWriteLock(var2):new CycleDetectingLockFactory.CycleDetectingReentrantReadWriteLock(new CycleDetectingLockFactory.LockGraphNode(var1), var2, null));
   }
   ...
   private static class LockGraphNode {
      ...
      void checkAcquiredLock(CycleDetectingLockFactory.Policy var1, CycleDetectingLockFactory.LockGraphNode var2) {
         ...
         if(!this.allowedPriorLocks.containsKey(var2)) {
            ...
            if(var3 != null) {
               CycleDetectingLockFactory.PotentialDeadlockException var7 = new CycleDetectingLockFactory.PotentialDeadlockException(var2, this, var3.getConflictingStackTrace(), null);
               ...
               if(var5 == null) {
                  ...
                  CycleDetectingLockFactory.PotentialDeadlockException var6 = new CycleDetectingLockFactory.PotentialDeadlockException(var2, this, var5, null);
   ...
   public static final class WithExplicitOrdering<E extends Enum<E>> extends CycleDetectingLockFactory {
      ...
      public ReentrantLock newReentrantLock(E var1, boolean var2) {
         return (ReentrantLock)(this.policy == CycleDetectingLockFactory.Policies.DISABLED?new ReentrantLock(var2):new CycleDetectingLockFactory.CycleDetectingReentrantLock((CycleDetectingLockFactory.LockGraphNode)this.lockGraphNodes.get(var1), var2, null));
      }
      ...
      public ReentrantReadWriteLock newReentrantReadWriteLock(E var1, boolean var2) {
         return (ReentrantReadWriteLock)(this.policy == CycleDetectingLockFactory.Policies.DISABLED?new ReentrantReadWriteLock(var2):new CycleDetectingLockFactory.CycleDetectingReentrantReadWriteLock((CycleDetectingLockFactory.LockGraphNode)this.lockGraphNodes.get(var1), var2, null));
      }
   }
