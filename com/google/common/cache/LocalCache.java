...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
   ...
   static final LocalCache.ValueReference<Object, Object> UNSET = new LocalCache.ValueReference() {
      public Object get() {
         return null;
      }
   ...
   ImmutableMap<K, V> getAll(Iterable<? extends K> var1) throws ExecutionException {
      ...
      try {
         ...
         var16 = ImmutableMap.copyOf(var4);
      } finally {
         this.globalStatsCounter.recordHits(var2);
         this.globalStatsCounter.recordMisses(var3);
      }
   ...
   static class LocalManualCache<K, V> implements Cache<K, V>, Serializable {
      ...
      public V get(K var1, final Callable<? extends V> var2) throws ExecutionException {
         Preconditions.checkNotNull(var2);
         return this.localCache.get(var1, new CacheLoader() {
   ...
   abstract class AbstractCacheSet<T> extends AbstractSet<T> {
      ...
      AbstractCacheSet(ConcurrentMap<?, ?> var1) {
         this.map = var2;
      }
      ...
      public ListenableFuture<V> loadFuture(K var1, CacheLoader<? super K, V> var2) {
         ...
         try {
            if(var3 == null) {
               ...
               return var4 == null?Futures.immediateFuture((Object)null):Futures.transform(var4, new Function() {
   ...
   static class Segment<K, V> extends ReentrantLock {
      ...
      Segment(LocalCache<K, V> var1, int var2, long var3, AbstractCache.StatsCounter var5) {
         ...
         this.recencyQueue = (Queue)(var1.usesAccessQueue()?new ConcurrentLinkedQueue():LocalCache.DISCARDING_QUEUE);
         this.writeQueue = (Queue)(var1.usesWriteQueue()?new LocalCache.WriteQueue():LocalCache.DISCARDING_QUEUE);
         this.accessQueue = (Queue)(var1.usesAccessQueue()?new LocalCache.AccessQueue():LocalCache.DISCARDING_QUEUE);
      }
      ...
      V get(K var1, int var2, CacheLoader<? super K, V> var3) throws ExecutionException {
         ...
         try {
            ...
            var15 = this.lockedGetOrLoad(var1, var2, var3);
      ...
      ListenableFuture<V> loadAsync(final K var1, final int var2, final LocalCache.LoadingValueReference<K, V> var3, CacheLoader<? super K, V> var4) {
         ...
         var5.addListener(new Runnable() {
            public void run() {
               try {
                  Object var1x = Segment.this.getAndRecordStats(var1, var2, var3, var5);
      ...
      @GuardedBy("Segment.this")
      void enqueueNotification(LocalCache.ReferenceEntry<K, V> var1, RemovalCause var2) {
         this.enqueueNotification(var1.getKey(), var1.getHash(), var1.getValueReference(), var2);
      }

      @GuardedBy("Segment.this")
      void enqueueNotification(@Nullable K var1, int var2, LocalCache.ValueReference<K, V> var3, RemovalCause var4) {
      ...
      @Nullable
      @GuardedBy("Segment.this")
      LocalCache.ReferenceEntry<K, V> removeValueFromChain(LocalCache.ReferenceEntry<K, V> var1, LocalCache.ReferenceEntry<K, V> var2, @Nullable K var3, int var4, LocalCache.ValueReference<K, V> var5, RemovalCause var6) {
         ...
         try {
            ...
            for(LocalCache.ReferenceEntry var8 = var7; var8 != null; var8 = var8.getNext()) {
               ...
               if(var8.getHash() == var2 && var9 != null && this.map.keyEquivalence.equivalent(var1, var9)) {
                  ...
                  ++this.modCount;
                  LocalCache.ReferenceEntry var11 = this.removeValueFromChain(var7, var8, var9, var2, var3, RemovalCause.COLLECTED);
                  var4 = this.count - 1;
                  var5.set(var6, var11);
                  this.count = var4;
                  boolean var12 = true;
