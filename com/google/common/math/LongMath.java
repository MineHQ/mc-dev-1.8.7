...
public final class LongMath {
   ...
   public static int log2(long var0, RoundingMode var2) {
      ...
      switch(LongMath.SyntheticClass_1.$SwitchMap$java$math$RoundingMode[var2.ordinal()]) {
      case 1:
   ...
   public static long divide(long var0, long var2, RoundingMode var4) {
      ...
      if(var7 == 0L) {
         ...
         boolean var10;
         switch(LongMath.SyntheticClass_1.$SwitchMap$java$math$RoundingMode[var4.ordinal()]) {
         case 1:
