...
public final class IntMath {
   ...
   public static int log2(int var0, RoundingMode var1) {
      ...
      switch(IntMath.SyntheticClass_1.$SwitchMap$java$math$RoundingMode[var1.ordinal()]) {
      case 1:
   ...
   public static int divide(int var0, int var1, RoundingMode var2) {
      ...
      if(var1 == 0) {
         ...
         if(var4 == 0) {
            ...
            boolean var6;
            switch(IntMath.SyntheticClass_1.$SwitchMap$java$math$RoundingMode[var2.ordinal()]) {
            case 1:
