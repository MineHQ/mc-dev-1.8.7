...
public final class $Gson$Types {
   ...
   public static ParameterizedType newParameterizedTypeWithOwner(Type var0, Type var1, Type... var2) {
      return new $Gson$Types.Gson$Types$ParameterizedTypeImpl(var0, var1, var2);
   }

   public static GenericArrayType arrayOf(Type var0) {
      return new $Gson$Types.Gson$Types$GenericArrayTypeImpl(var0);
   }

   public static WildcardType subtypeOf(Type var0) {
      return new $Gson$Types.Gson$Types$WildcardTypeImpl(new Type[]{var0}, EMPTY_TYPE_ARRAY);
   }

   public static WildcardType supertypeOf(Type var0) {
      return new $Gson$Types.Gson$Types$WildcardTypeImpl(new Type[]{Object.class}, new Type[]{var0});
   }

   public static Type canonicalize(Type var0) {
      if(var0 instanceof Class) {
         Class var4 = (Class)var0;
         return (Type)(var4.isArray()?new $Gson$Types.Gson$Types$GenericArrayTypeImpl(canonicalize(var4.getComponentType())):var4);
      } else if(var0 instanceof ParameterizedType) {
         ParameterizedType var3 = (ParameterizedType)var0;
         return new $Gson$Types.Gson$Types$ParameterizedTypeImpl(var3.getOwnerType(), var3.getRawType(), var3.getActualTypeArguments());
      } else if(var0 instanceof GenericArrayType) {
         GenericArrayType var2 = (GenericArrayType)var0;
         return new $Gson$Types.Gson$Types$GenericArrayTypeImpl(var2.getGenericComponentType());
      } else if(var0 instanceof WildcardType) {
         WildcardType var1 = (WildcardType)var0;
         return new $Gson$Types.Gson$Types$WildcardTypeImpl(var1.getUpperBounds(), var1.getLowerBounds());
      } else {
         return var0;
      }
   }
   ...
   private static final class Gson$Types$WildcardTypeImpl implements WildcardType, Serializable {
   ...
   private static final class Gson$Types$GenericArrayTypeImpl implements GenericArrayType, Serializable {
   ...
   private static final class Gson$Types$ParameterizedTypeImpl implements ParameterizedType, Serializable {
