   ...
   private int nextNonWhitespace(boolean var1) throws IOException {
      ...
      while(true) {
         ...
         if(var5 == 10) {
            ++this.lineNumber;
            this.lineStart = var3;
         } else if(var5 != 32 && var5 != 13 && var5 != 9) {
            if(var5 == 47) {
               this.pos = var3;
               if(var3 == var4) {
                  --this.pos;
         ...
         public void promoteNameToValue(JsonReader var1) throws IOException {
            if(var1 instanceof JsonTreeReader) {
               ...
               if(var2 == 13) {
                  ...
                  if(var2 != 14) {
                     throw new IllegalStateException("Expected a name but was " + var1.peek() + " " + " at line " + var1.getLineNumber() + " column " + var1.getColumnNumber());
                  }
