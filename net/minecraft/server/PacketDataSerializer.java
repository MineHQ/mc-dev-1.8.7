...
public class PacketDataSerializer extends ByteBuf {
   ...
   public void a(IChatBaseComponent var1) throws IOException {
      this.a(IChatBaseComponent.ChatSerializer.a(var1));
   }
   ...
   public void a(NBTTagCompound var1) {
      if(var1 == null) {
         ...
         try {
            NBTCompressedStreamTools.a((NBTTagCompound)var1, (DataOutput)(new ByteBufOutputStream(this)));
   ...
   public void a(ItemStack var1) {
      if(var1 == null) {
         ...
         if(var1.getItem().usesDurability() || var1.getItem().p()) {
            var2 = var1.getTag();
         }
   ...
   public ItemStack i() throws IOException {
      ...
      if(var2 >= 0) {
         ...
         var1 = new ItemStack(Item.getById(var2), var3, var4);
         var1.setTag(this.h());
      }
