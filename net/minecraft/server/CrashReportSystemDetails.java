...
public class CrashReportSystemDetails {
   ...
   public void a(String var1, Object var2) {
      this.c.add(new CrashReportSystemDetails.CrashReportDetail(var1, var2));
   }
   ...
   public void a(StringBuilder var1) {
      ...
      while(var2.hasNext()) {
         CrashReportSystemDetails.CrashReportDetail var3 = (CrashReportSystemDetails.CrashReportDetail)var2.next();
         var1.append("\n\t");
         var1.append(var3.a());
         var1.append(": ");
         var1.append(var3.b());
   ...
   public static void a(CrashReportSystemDetails var0, final BlockPosition var1, final Block var2, final int var3) {
   ...
   public static void a(CrashReportSystemDetails var0, final BlockPosition var1, final IBlockData var2) {
   ...
   static class CrashReportDetail {
      ...
      public CrashReportDetail(String var1, Object var2) {
         this.a = var1;
         if(var2 == null) {
            this.b = "~~NULL~~";
