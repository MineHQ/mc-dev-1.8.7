...
public class ServerPing {
   ...
   public static class Serializer implements JsonDeserializer<ServerPing>, JsonSerializer<ServerPing> {
      ...
      public ServerPing a(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
         JsonObject var4 = ChatDeserializer.l(var1, "status");
         ServerPing var5 = new ServerPing();
         if(var4.has("description")) {
            var5.setMOTD((IChatBaseComponent)var3.deserialize(var4.get("description"), IChatBaseComponent.class));
         }

         if(var4.has("players")) {
            var5.setPlayerSample((ServerPing.ServerPingPlayerSample)var3.deserialize(var4.get("players"), ServerPing.ServerPingPlayerSample.class));
         }

         if(var4.has("version")) {
            var5.setServerInfo((ServerPing.ServerData)var3.deserialize(var4.get("version"), ServerPing.ServerData.class));
         }

         if(var4.has("favicon")) {
            var5.setFavicon(ChatDeserializer.h(var4, "favicon"));
         }
   ...
   public static class ServerData {
      ...
      public static class ServerData$Serializer implements JsonDeserializer<ServerPing.ServerData>, JsonSerializer<ServerPing.ServerData> {
         ...
         public ServerPing.ServerData a(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
            JsonObject var4 = ChatDeserializer.l(var1, "version");
            return new ServerPing.ServerData(ChatDeserializer.h(var4, "name"), ChatDeserializer.m(var4, "protocol"));
         }
   ...
   public static class ServerPingPlayerSample {
      ...
      public static class ServerPingPlayerSample$Serializer implements JsonDeserializer<ServerPing.ServerPingPlayerSample>, JsonSerializer<ServerPing.ServerPingPlayerSample> {
         ...
         public ServerPing.ServerPingPlayerSample a(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
            JsonObject var4 = ChatDeserializer.l(var1, "players");
            ServerPing.ServerPingPlayerSample var5 = new ServerPing.ServerPingPlayerSample(ChatDeserializer.m(var4, "max"), ChatDeserializer.m(var4, "online"));
            if(ChatDeserializer.d(var4, "sample")) {
               JsonArray var6 = ChatDeserializer.t(var4, "sample");
               if(var6.size() > 0) {
                  GameProfile[] var7 = new GameProfile[var6.size()];

                  for(int var8 = 0; var8 < var7.length; ++var8) {
                     JsonObject var9 = ChatDeserializer.l(var6.get(var8), "player[" + var8 + "]");
                     String var10 = ChatDeserializer.h(var9, "id");
                     var7[var8] = new GameProfile(UUID.fromString(var10), ChatDeserializer.h(var9, "name"));
                  }
