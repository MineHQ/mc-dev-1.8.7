...
public abstract class WorldGenMegaTreeAbstract extends WorldGenTreeAbstract {
   ...
   public WorldGenMegaTreeAbstract(boolean var1, int var2, int var3, IBlockData var4, IBlockData var5) {
      super(var1);
      this.a = var2;
      this.d = var3;
      this.b = var4;
         ...
         for(int var5 = 0; var5 <= 1 + var3; ++var5) {
            ...
            for(int var7 = -var6; var7 <= var6 && var4; ++var7) {
               for(int var8 = -var6; var8 <= var6 && var4; ++var8) {
                  if(var2.getY() + var5 < 0 || var2.getY() + var5 >= 256 || !this.a(var1.getType(var2.a(var7, var5, var8)).getBlock())) {
                     var4 = false;
                  }
               }
            }
      ...
      for(int var5 = -var3; var5 <= var3 + 1; ++var5) {
         for(int var6 = -var3; var6 <= var3 + 1; ++var6) {
            ...
            if(var5 * var5 + var6 * var6 <= var4 || var7 * var7 + var8 * var8 <= var4 || var5 * var5 + var8 * var8 <= var4 || var7 * var7 + var6 * var6 <= var4) {
               BlockPosition var9 = var2.a(var5, 0, var6);
      ...
      for(int var5 = -var3; var5 <= var3; ++var5) {
         for(int var6 = -var3; var6 <= var3; ++var6) {
            if(var5 * var5 + var6 * var6 <= var4) {
               BlockPosition var7 = var2.a(var5, 0, var6);
