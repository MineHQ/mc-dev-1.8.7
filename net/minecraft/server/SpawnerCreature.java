...
public final class SpawnerCreature {
      ...
      if(!var2 && !var3) {
         ...
         while(true) {
            ...
            do {
               if(!var6.hasNext()) {
                  int var36 = 0;
                  BlockPosition var37 = var1.getSpawn();
                        ...
                        if(var12 <= var41) {
                           ...
                           while(true) {
                              ...
                              do {
                                 ...
                                 BlockPosition var16 = getRandomPosition(var1, var15.x, var15.z);
                                 var17 = var16.getX();
                                 var18 = var16.getY();
                                 var19 = var16.getZ();
                              ...
                              for(int var22 = 0; var22 < 3; ++var22) {
                                 ...
                                 for(int var29 = 0; var29 < 4; ++var29) {
                                    ...
                                    if(!var1.isPlayerNearby((double)var31, (double)var24, (double)var32, 24.0D) && var37.c((double)var31, (double)var24, (double)var32) >= 576.0D) {
                                       if(var27 == null) {
                                       ...
                                       if(var1.a(var40, var27, var30) && a(EntityPositionTypes.a(var27.b), var1, var30)) {
                                          ...
                                          if(var33.bR() && var33.canSpawn()) {
                                             var28 = var33.prepare(var1.E(new BlockPosition(var33)), var28);
                                             if(var33.canSpawn()) {
                                                ++var21;
            ...
            for(int var11 = -var10; var11 <= var10; ++var11) {
               for(var12 = -var10; var12 <= var10; ++var12) {
                  ...
                  if(!this.b.contains(var14)) {
                     ++var5;
                     if(!var13 && var1.getWorldBorder().isInBounds(var14)) {
                        this.b.add(var14);
                     }
                  }
               }
   ...
   protected static BlockPosition getRandomPosition(World var0, int var1, int var2) {
      Chunk var3 = var0.getChunkAt(var1, var2);
      int var4 = var1 * 16 + var0.random.nextInt(16);
      int var5 = var2 * 16 + var0.random.nextInt(16);
      int var6 = MathHelper.c(var3.f(new BlockPosition(var4, 0, var5)) + 1, 16);
   ...
   public static void a(World var0, BiomeBase var1, int var2, int var3, int var4, int var5, Random var6) {
      ...
      if(!var7.isEmpty()) {
         while(var6.nextFloat() < var1.g()) {
            BiomeBase.BiomeMeta var8 = (BiomeBase.BiomeMeta)WeightedRandom.a(var0.random, var7);
            int var9 = var8.c + var6.nextInt(1 + var8.d - var8.c);
            GroupDataEntity var10 = null;
            ...
            for(int var15 = 0; var15 < var9; ++var15) {
               ...
               for(int var17 = 0; !var16 && var17 < 4; ++var17) {
                  ...
                  if(a(EntityInsentient.EnumEntityPositionType.ON_GROUND, var0, var18)) {
                     ...
                     var0.addEntity(var19);
                     var10 = var19.prepare(var0.E(new BlockPosition(var19)), var10);
                     var16 = true;
                  }
