...
public class ShapeDetector {
   ...
   private ShapeDetector.ShapeDetectorCollection a(BlockPosition var1, EnumDirection var2, EnumDirection var3, LoadingCache<BlockPosition, ShapeDetectorBlock> var4) {
   ...
   public ShapeDetector.ShapeDetectorCollection a(World var1, BlockPosition var2) {
      ...
      Iterator var5 = BlockPosition.a(var2, var2.a(var4 - 1, var4 - 1, var4 - 1)).iterator();
         ...
         for(int var9 = 0; var9 < var8; ++var9) {
            ...
            for(int var13 = 0; var13 < var12; ++var13) {
               ...
               if(var14 != var10 && var14 != var10.opposite()) {
                  ShapeDetector.ShapeDetectorCollection var15 = this.a(var6, var10, var14, var3);
                  if(var15 != null) {
                     return var15;
                  }
               }
   ...
   public static class ShapeDetectorCollection {
      ...
      public ShapeDetectorCollection(BlockPosition var1, EnumDirection var2, EnumDirection var3, LoadingCache<BlockPosition, ShapeDetectorBlock> var4, int var5, int var6, int var7) {
         this.a = var1;
         this.b = var2;
         this.c = var3;
         this.d = var4;
