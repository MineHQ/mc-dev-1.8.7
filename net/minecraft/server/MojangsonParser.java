...
public class MojangsonParser {
   ...
   public static NBTTagCompound parse(String var0) throws MojangsonParseException {
      var0 = var0.trim();
      if(!var0.startsWith("{")) {
   ...
   static int b(String var0) throws MojangsonParseException {
      int var1 = 0;
      boolean var2 = false;
      ...
      for(int var4 = 0; var4 < var0.length(); ++var4) {
         ...
         if(var5 == 34) {
            if(b(var0, var4)) {
               if(!var2) {
                  throw new MojangsonParseException("Illegal use of \\\": " + var0);
               }
            } else {
               var2 = !var2;
            }
            ...
            if(var5 != 123 && var5 != 91) {
               if(var5 == 125 && (var3.isEmpty() || ((Character)var3.pop()).charValue() != 123)) {
                  throw new MojangsonParseException("Unbalanced curly brackets {}: " + var0);
               }

               if(var5 == 93 && (var3.isEmpty() || ((Character)var3.pop()).charValue() != 91)) {
                  throw new MojangsonParseException("Unbalanced square brackets []: " + var0);
               }
            } else {
               if(var3.isEmpty()) {
                  ++var1;
      ...
      if(var2) {
         throw new MojangsonParseException("Unbalanced quotation: " + var0);
      } else if(!var3.isEmpty()) {
         throw new MojangsonParseException("Unbalanced brackets: " + var0);
      } else {
   ...
   static MojangsonParser.MojangsonTypeParser a(String... var0) throws MojangsonParseException {
      return a(var0[0], var0[1]);
   }

   static MojangsonParser.MojangsonTypeParser a(String var0, String var1) throws MojangsonParseException {
      var1 = var1.trim();
      String var3;
      boolean var4;
      char var6;
      if(var1.startsWith("{")) {
         ...
         MojangsonParser.MojangsonCompoundParser var5;
         for(var5 = new MojangsonParser.MojangsonCompoundParser(var0); var1.length() > 0; var1 = var1.substring(var3.length() + 1)) {
            var3 = b(var1, true);
            if(var3.length() > 0) {
               var4 = false;
            ...
            if(var6 != 44 && var6 != 123 && var6 != 125 && var6 != 91 && var6 != 93) {
               throw new MojangsonParseException("Unexpected token \'" + var6 + "\' at: " + var1.substring(var3.length()));
            }
         }
         ...
         MojangsonParser.MojangsonListParser var2;
         for(var2 = new MojangsonParser.MojangsonListParser(var0); var1.length() > 0; var1 = var1.substring(var3.length() + 1)) {
            var3 = b(var1, false);
            if(var3.length() > 0) {
               var4 = true;
         ...
         return new MojangsonParser.MojangsonPrimitiveParser(var0, var1);
      }
   }

   private static MojangsonParser.MojangsonTypeParser a(String var0, boolean var1) throws MojangsonParseException {
      String var2 = c(var0, var1);
      String var3 = d(var0, var1);
      return a(new String[]{var2, var3});
   }

   private static String b(String var0, boolean var1) throws MojangsonParseException {
      int var2 = a(var0, ':');
      int var3 = a(var0, ',');
      if(var1) {
         if(var2 == -1) {
            throw new MojangsonParseException("Unable to locate name/value separator for string: " + var0);
         }

         if(var3 != -1 && var3 < var2) {
            throw new MojangsonParseException("Name error at: " + var0);
         }
   ...
   private static String a(String var0, int var1) throws MojangsonParseException {
   ...
   private static String c(String var0, boolean var1) throws MojangsonParseException {
      if(var1) {
         var0 = var0.trim();
   ...
   private static String d(String var0, boolean var1) throws MojangsonParseException {
      if(var1) {
         var0 = var0.trim();
         if(var0.startsWith("{") || var0.startsWith("[")) {
            return var0;
   ...
   static class MojangsonPrimitiveParser extends MojangsonParser.MojangsonTypeParser {
      ...
      public MojangsonPrimitiveParser(String var1, String var2) {
         this.a = var1;
         this.b = var2;
      }
   ...
   static class MojangsonListParser extends MojangsonParser.MojangsonTypeParser {
      ...
      public MojangsonListParser(String var1) {
         this.a = var1;
      }
      ...
      public NBTBase a() throws MojangsonParseException {
         ...
         while(var2.hasNext()) {
            MojangsonParser.MojangsonTypeParser var3 = (MojangsonParser.MojangsonTypeParser)var2.next();
            var1.add(var3.a());
         }
   ...
   static class MojangsonCompoundParser extends MojangsonParser.MojangsonTypeParser {
      ...
      public MojangsonCompoundParser(String var1) {
         this.a = var1;
      }
