...
public class BlockFlowing extends BlockFluids {
   ...
   private void f(World var1, BlockPosition var2, IBlockData var3) {
      var1.setTypeAndData(var2, b(this.material).getBlockData().set(LEVEL, var3.get(LEVEL)), 2);
   }
   ...
   public void b(World var1, BlockPosition var2, IBlockData var3, Random var4) {
      ...
      if(var5 > 0) {
         ...
         if(this.e(var1, var2.up()) >= 0) {
            var15 = this.e(var1, var2.up());
            if(var15 >= 8) {
               var14 = var15;
            } else {
               var14 = var15 + 8;
         ...
         if(this.a >= 2 && this.material == Material.WATER) {
            ...
            if(var16.getBlock().getMaterial().isBuildable()) {
               var14 = 0;
            } else if(var16.getBlock().getMaterial() == this.material && ((Integer)var16.get(LEVEL)).intValue() == 0) {
               var14 = 0;
            }
         }
      ...
      if(this.h(var1, var2.down(), var13)) {
         if(this.material == Material.LAVA && var1.getType(var2.down()).getBlock().getMaterial() == Material.WATER) {
            var1.setTypeUpdate(var2.down(), Blocks.STONE.getBlockData());
            this.fizz(var1, var2.down());
            return;
         }

         if(var5 >= 8) {
            this.flow(var1, var2.down(), var13, var5);
         } else {
            this.flow(var1, var2.down(), var13, var5 + 8);
         }
         ...
         while(var11.hasNext()) {
            ...
            this.flow(var1, var2.shift(var12), var1.getType(var2.shift(var12)), var15);
         }
      }

   }

   private void flow(World var1, BlockPosition var2, IBlockData var3, int var4) {
      if(this.h(var1, var2, var3)) {
         ...
         var1.setTypeAndData(var2, this.getBlockData().set(LEVEL, Integer.valueOf(var4)), 3);
      }
   ...
   private int a(World var1, BlockPosition var2, int var3, EnumDirection var4) {
      ...
      while(true) {
         ...
         } while(var9.getBlock().getMaterial() == this.material && ((Integer)var9.get(LEVEL)).intValue() <= 0);
   ...
   private Set<EnumDirection> f(World var1, BlockPosition var2) {
      ...
      while(true) {
         ...
         } while(var8.getBlock().getMaterial() == this.material && ((Integer)var8.get(LEVEL)).intValue() <= 0);
