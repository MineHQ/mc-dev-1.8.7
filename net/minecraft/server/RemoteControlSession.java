...
public class RemoteControlSession extends RemoteConnectionThread {
   ...
   RemoteControlSession(IMinecraftServer var1, Socket var2) {
   ...
   public void run() {
      while(true) {
         try {
            ...
            byte var3 = 0;
            int var4 = StatusChallengeUtils.b(this.k, 0, var2);
            if(var4 == var2 - 4) {
               int var21 = var3 + 4;
               int var5 = StatusChallengeUtils.b(this.k, var21, var2);
               var21 += 4;
               int var6 = StatusChallengeUtils.b(this.k, var21);
               var21 += 4;
               switch(var6) {
               case 2:
                  if(this.i) {
                     String var8 = StatusChallengeUtils.a(this.k, var21, var2);

                     try {
                        this.a(var5, this.b.executeRemoteCommand(var8));
                  ...
                  continue;
               case 3:
                  String var7 = StatusChallengeUtils.a(this.k, var21, var2);
