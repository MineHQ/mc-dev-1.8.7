         ...
         if(var4 >= 1 && var3 == 1 && var7 == 0) {
            ...
            if(var6 > 0) {
               ...
               for(int var22 = 0; var22 < var1.getSize(); ++var22) {
                  ...
                  if(var26 != null && var26.getItem() == Items.FIREWORK_CHARGE && var26.hasTag() && var26.getTag().hasKeyOfType("Explosion", 10)) {
                     var25.add(var26.getTag().getCompound("Explosion"));
                  }
               }

               var19.set("Explosions", var25);
               var19.setByte("Flight", (byte)var4);
               var16.set("Fireworks", var19);
               this.a.setTag(var16);
            }
            ...
            for(int var17 = 0; var17 < var1.getSize(); ++var17) {
               ...
               if(var11 != null) {
                  if(var11.getItem() == Items.DYE) {
                     var15.add(Integer.valueOf(ItemDye.a[var11.getData() & 15]));
