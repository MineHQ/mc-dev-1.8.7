...
public class NameReferencingFileConverter {
   ...
   public static boolean a(final MinecraftServer var0) {
      final GameProfileBanList var1 = new GameProfileBanList(PlayerList.a);
            ...
            ProfileLookupCallback var3 = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile var1x) {
                  ...
                  if(var2x == null) {
                     ...
                     var1.add(new GameProfileBanEntry(var1x, var3, var4, var5, var6));
                  }
               }
               ...
               public void onProfileLookupFailed(GameProfile var1x, Exception var2x) {
                  ...
                  if(!(var2x instanceof ProfileNotFoundException)) {
                     throw new NameReferencingFileConverter.FileConversionException("Could not request user " + var1x.getName() + " from backend systems", var2x, null);
                  }
               }
            };
   ...
   public static boolean c(final MinecraftServer var0) {
      final OpList var1 = new OpList(PlayerList.c);
      if(c.exists() && c.isFile()) {
         ...
         try {
            ...
            ProfileLookupCallback var3 = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile var1x) {
                  var0.getUserCache().a(var1x);
                  var1.add(new OpListEntry(var1x, var0.p(), false));
               }
               ...
               public void onProfileLookupFailed(GameProfile var1x, Exception var2) {
                  ...
                  if(!(var2 instanceof ProfileNotFoundException)) {
                     throw new NameReferencingFileConverter.FileConversionException("Could not request user " + var1x.getName() + " from backend systems", var2, null);
                  }
               }
            };
            a(var0, var2, var3);
   ...
   public static boolean d(final MinecraftServer var0) {
      final WhiteList var1 = new WhiteList(PlayerList.d);
      if(d.exists() && d.isFile()) {
         ...
         try {
            ...
            ProfileLookupCallback var3 = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile var1x) {
                  var0.getUserCache().a(var1x);
                  var1.add(new WhiteListEntry(var1x));
               }
   ...
   public static String a(String var0) {
      if(!UtilColor.b(var0) && var0.length() <= 16) {
         ...
         try {
            ...
            ProfileLookupCallback var15 = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile var1) {
                  var0.getUserCache().a(var1);
                  UUID var2x = var1.getId();
                  if(var2x == null) {
                     throw new NameReferencingFileConverter.FileConversionException("Missing UUID for user profile " + var1.getName(), null);
                  } else {
               ...
               public void onProfileLookupFailed(GameProfile var1, Exception var2x) {
                  ...
                  if(var2x instanceof ProfileNotFoundException) {
                     ...
                     throw new NameReferencingFileConverter.FileConversionException("Could not request user " + var1.getName() + " from backend systems", var2x, null);
                  }
               }
               ...
               private void a(File var1, String var2x, String var3x) {
                  ...
                  if(!var4x.renameTo(var5)) {
                     throw new NameReferencingFileConverter.FileConversionException("Could not convert file for " + var2x, null);
                  }
               }
               ...
               private String a(GameProfile var1) {
                  ...
                  if(var2x == null) {
                     throw new NameReferencingFileConverter.FileConversionException("Could not find the filename for " + var1.getName() + " anymore", null);
                  } else {
                     return var2x;
                  }
               }
            ...
            return true;
         } catch (NameReferencingFileConverter.FileConversionException var13) {
   ...
   private static void b(File var0) {
      if(var0.exists()) {
         if(!var0.isDirectory()) {
            throw new NameReferencingFileConverter.FileConversionException("Can\'t create directory " + var0.getName() + " in world save directory.", null);
         }
      } else if(!var0.mkdirs()) {
         throw new NameReferencingFileConverter.FileConversionException("Can\'t create directory " + var0.getName() + " in world save directory.", null);
      }
   ...
   static class FileConversionException extends RuntimeException {
      private FileConversionException(String var1, Throwable var2) {
         super(var1, var2);
      }

      private FileConversionException(String var1) {
         super(var1);
      }

      // $FF: synthetic method
      FileConversionException(String var1, Object var2) {
         this(var1);
      }

      // $FF: synthetic method
      FileConversionException(String var1, Throwable var2, Object var3) {
         this(var1, var2);
      }
   }
}
