...
import net.minecraft.server.WorldGenMegaTreeAbstract;

public class WorldGenJungleTree extends WorldGenMegaTreeAbstract {
   public WorldGenJungleTree(boolean var1, int var2, int var3, IBlockData var4, IBlockData var5) {
      ...
      if(!this.a(var1, var2, var3, var4)) {
         ...
         for(int var13 = 0; var13 < var4; ++var13) {
            ...
            if(this.a(var1.getType(var14).getBlock())) {
               ...
               if(var13 > 0) {
                  this.a(var1, var2, var14.west(), BlockVine.EAST);
                  this.a(var1, var2, var14.north(), BlockVine.SOUTH);
               }
            }
            ...
            if(var13 < var4 - 1) {
               ...
               if(this.a(var1.getType(var15).getBlock())) {
                  ...
                  if(var13 > 0) {
                     this.a(var1, var2, var15.east(), BlockVine.WEST);
                     this.a(var1, var2, var15.north(), BlockVine.SOUTH);
                  }
               }
               ...
               if(this.a(var1.getType(var16).getBlock())) {
                  ...
                  if(var13 > 0) {
                     this.a(var1, var2, var16.east(), BlockVine.WEST);
                     this.a(var1, var2, var16.south(), BlockVine.NORTH);
                  }
               }
               ...
               if(this.a(var1.getType(var17).getBlock())) {
                  ...
                  if(var13 > 0) {
                     this.a(var1, var2, var17.west(), BlockVine.EAST);
                     this.a(var1, var2, var17.south(), BlockVine.NORTH);
                  }
               }
            }
         }
