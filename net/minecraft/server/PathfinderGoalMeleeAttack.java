...
public class PathfinderGoalMeleeAttack extends PathfinderGoal {
   ...
   public PathfinderGoalMeleeAttack(EntityCreature var1, Class<? extends Entity> var2, double var3, boolean var5) {
      this(var1, var3, var5);
      this.g = var2;
   }
   ...
   public boolean b() {
      EntityLiving var1 = this.b.getGoalTarget();
      return var1 == null?false:(!var1.isAlive()?false:(!this.e?!this.b.getNavigation().m():this.b.e(new BlockPosition(var1))));
   }
