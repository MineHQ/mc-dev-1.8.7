...
import net.minecraft.server.BiomeSavanna;
import net.minecraft.server.BiomeStoneBeach;
...
import net.minecraft.server.WorldGenTallPlant;
...
public abstract class BiomeBase {
   ...
   public static final BiomeBase MESA_PLATEAU_F;
   public static final BiomeBase MESA_PLATEAU;
   ...
   public List<BiomeBase.BiomeMeta> getMobs(EnumCreatureType var1) {
      switch(BiomeBase.SyntheticClass_1.switchMap[var1.ordinal()]) {
      case 1:
         return this.at;
      case 2:
         return this.au;
   ...
   protected BiomeBase d(int var1) {
      return new BiomeBaseSub(var1, this);
   }
   ...
   public static BiomeBase getBiome(int var0, BiomeBase var1) {
      if(var0 >= 0 && var0 <= biomes.length) {
         BiomeBase var2 = biomes[var0];
   ...
   static {
      ...
      SKY = (new BiomeTheEnd(9)).b(8421631).a("The End").b();
      ...
      JUNGLE_EDGE = (new BiomeJungle(23, true)).b(6458135).a("JungleEdge").a(5470985).a(0.95F, 0.8F);
      ...
      SAVANNA_PLATEAU = (new BiomeSavanna(36)).b(10984804).a("Savanna Plateau").a(1.0F, 0.0F).b().a(h);
      MESA = (new BiomeMesa(37, false, false)).b(14238997).a("Mesa");
      MESA_PLATEAU_F = (new BiomeMesa(38, false, true)).b(11573093).a("Mesa Plateau F").a(h);
      MESA_PLATEAU = (new BiomeMesa(39, false, false)).b(13274213).a("Mesa Plateau").a(h);
      ad = OCEAN;
      PLAINS.k();
      DESERT.k();
      FOREST.k();
   ...
   public static class BiomeMeta extends WeightedRandom.WeightedRandomChoice {
      ...
      public BiomeMeta(Class<? extends EntityInsentient> var1, int var2, int var3, int var4) {
         super(var2);
         this.b = var1;
         this.c = var3;
         this.d = var4;
