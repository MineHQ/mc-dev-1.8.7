...
public class WorldGenBigTree extends WorldGenTreeAbstract {
   ...
   void a() {
      ...
      this.j.add(new WorldGenBigTree.Position(this.m.up(var3), var2));
      ...
      for(; var3 >= 0; --var3) {
         ...
         if(var4 >= 0.0F) {
            for(int var5 = 0; var5 < var1; ++var5) {
               ...
               BlockPosition var14 = this.m.a(var10, (double)(var3 - 1), var12);
               ...
               if(this.a(var14, var15) == -1) {
                  ...
                  if(this.a(var21, var14) == -1) {
                     this.j.add(new WorldGenBigTree.Position(var14, var21.getY()));
                  }
               }
            }
         }
      ...
      for(int var5 = -var4; var5 <= var4; ++var5) {
         for(int var6 = -var4; var6 <= var4; ++var6) {
            if(Math.pow((double)Math.abs(var5) + 0.5D, 2.0D) + Math.pow((double)Math.abs(var6) + 0.5D, 2.0D) <= (double)(var2 * var2)) {
               BlockPosition var7 = var1.a(var5, 0, var6);
   ...
   void a(BlockPosition var1, BlockPosition var2, Block var3) {
      BlockPosition var4 = var2.a(-var1.getX(), -var1.getY(), -var1.getZ());
      ...
      for(int var9 = 0; var9 <= var5; ++var9) {
         BlockPosition var10 = var1.a((double)(0.5F + (float)var9 * var6), (double)(0.5F + (float)var9 * var7), (double)(0.5F + (float)var9 * var8));
   ...
   void b() {
      ...
      while(var1.hasNext()) {
         WorldGenBigTree.Position var2 = (WorldGenBigTree.Position)var1.next();
         this.a(var2);
      }
   ...
   int a(BlockPosition var1, BlockPosition var2) {
      BlockPosition var3 = var2.a(-var1.getX(), -var1.getY(), -var1.getZ());
      ...
      if(var4 == 0) {
         ...
         for(int var8 = 0; var8 <= var4; ++var8) {
            BlockPosition var9 = var1.a((double)(0.5F + (float)var8 * var5), (double)(0.5F + (float)var8 * var6), (double)(0.5F + (float)var8 * var7));
   ...
   static class Position extends BlockPosition {
      ...
      public Position(BlockPosition var1, int var2) {
