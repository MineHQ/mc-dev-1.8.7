...
public class UserCache {
   ...
   public UserCache(MinecraftServer var1, File var2) {
      ...
      var3.registerTypeHierarchyAdapter(UserCache.UserCacheEntry.class, new UserCache.BanEntrySerializer(null));
      this.b = var3.create();
      this.b();
   }
   ...
   private static GameProfile a(MinecraftServer var0, String var1) {
      ...
      if(!var0.getOnlineMode() && var2[0] == null) {
   ...
   private void a(GameProfile var1, Date var2) {
      ...
      UserCache.UserCacheEntry var5 = new UserCache.UserCacheEntry(var1, var2, null);
      if(this.d.containsKey(var3)) {
         UserCache.UserCacheEntry var6 = (UserCache.UserCacheEntry)this.d.get(var3);
   ...
   public GameProfile getProfile(String var1) {
      ...
      UserCache.UserCacheEntry var3 = (UserCache.UserCacheEntry)this.c.get(var2);
      ...
      if(var3 != null) {
         ...
         if(var4 != null) {
            this.a(var4);
            var3 = (UserCache.UserCacheEntry)this.c.get(var2);
         }
      }
   ...
   public GameProfile a(UUID var1) {
      UserCache.UserCacheEntry var2 = (UserCache.UserCacheEntry)this.d.get(var1);
      return var2 == null?null:var2.a();
   }

   private UserCache.UserCacheEntry b(UUID var1) {
      UserCache.UserCacheEntry var2 = (UserCache.UserCacheEntry)this.d.get(var1);
      if(var2 != null) {
   ...
   public void b() {
      ...
      try {
         ...
         while(var3.hasNext()) {
            UserCache.UserCacheEntry var4 = (UserCache.UserCacheEntry)var3.next();
            if(var4 != null) {
   ...
   private List<UserCache.UserCacheEntry> a(int var1) {
      ...
      while(var4.hasNext()) {
         ...
         UserCache.UserCacheEntry var6 = this.b(var5.getId());
         if(var6 != null) {
            var2.add(var6);
         }
      }
   ...
   class UserCacheEntry {
      ...
      private UserCacheEntry(GameProfile var2, Date var3) {
         this.b = var2;
         this.c = var3;
      }
      ...
      // $FF: synthetic method
      UserCacheEntry(GameProfile var2, Date var3, Object var4) {
         this();
      }
   }
   ...
   class BanEntrySerializer implements JsonDeserializer<UserCache.UserCacheEntry>, JsonSerializer<UserCache.UserCacheEntry> {
      ...
      public JsonElement a(UserCache.UserCacheEntry var1, Type var2, JsonSerializationContext var3) {
      ...
      public UserCache.UserCacheEntry a(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
         if(var1.isJsonObject()) {
            ...
            if(var5 != null && var6 != null) {
               ...
               if(var9 != null && var8 != null) {
                  ...
                  UserCache.UserCacheEntry var12 = UserCache.this.new UserCacheEntry(new GameProfile(var11, var9), var10, null);
                  return var12;
               } else {
                  return null;
               }
      ...
      public JsonElement serialize(Object var1, Type var2, JsonSerializationContext var3) {
         return this.a((UserCache.UserCacheEntry)var1, var2, var3);
      }
