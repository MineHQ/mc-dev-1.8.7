...
public class WorldGenAcaciaTree extends WorldGenTreeAbstract {
      ...
      if(var3.getY() >= 1 && var3.getY() + var4 + 1 <= 256) {
         ...
         if(!var5) {
            ...
            if((var20 == Blocks.GRASS || var20 == Blocks.DIRT) && var3.getY() < 256 - var4 - 1) {
               ...
               EnumDirection var21 = EnumDirection.EnumDirectionLimit.HORIZONTAL.a(var2);
               ...
               var10 = var3.getX();
               var11 = var3.getZ();
               EnumDirection var24 = EnumDirection.EnumDirectionLimit.HORIZONTAL.a(var2);
               if(var24 != var21) {
   ...
   static {
      a = Blocks.LOG2.getBlockData().set(BlockLog2.VARIANT, BlockWood.EnumLogVariant.ACACIA);
      b = Blocks.LEAVES2.getBlockData().set(BlockLeaves2.VARIANT, BlockWood.EnumLogVariant.ACACIA).set(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
   }
}
