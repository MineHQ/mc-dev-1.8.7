...
public class WorldGenTrees extends WorldGenTreeAbstract {
                  ...
                  if(var21.getMaterial() == Material.AIR || var21.getMaterial() == Material.LEAVES || var21.getMaterial() == Material.REPLACEABLE_PLANT) {
                     ...
                     if(this.d && var9 > 0) {
                        if(var2.nextInt(3) > 0 && var1.isEmpty(var3.a(-1, var9, 0))) {
                           this.a(var1, var3.a(-1, var9, 0), BlockVine.EAST);
                        }

                        if(var2.nextInt(3) > 0 && var1.isEmpty(var3.a(1, var9, 0))) {
                           this.a(var1, var3.a(1, var9, 0), BlockVine.WEST);
                        }

                        if(var2.nextInt(3) > 0 && var1.isEmpty(var3.a(0, var9, -1))) {
                           this.a(var1, var3.a(0, var9, -1), BlockVine.SOUTH);
                        }

                        if(var2.nextInt(3) > 0 && var1.isEmpty(var3.a(0, var9, 1))) {
                           this.a(var1, var3.a(0, var9, 1), BlockVine.NORTH);
                        }
                     }
                  }
               }
                     ...
                     for(var9 = 0; var9 < 2; ++var9) {
                        ...
                        while(var22.hasNext()) {
                           ...
                           if(var2.nextInt(4 - var9) == 0) {
                              ...
                              this.a(var1, var2.nextInt(3), var3.a(var25.getAdjacentX(), var4 - 5 + var9, var25.getAdjacentZ()), var23);
                           }
                        }
                     }
                  }
   ...
   private void a(World var1, int var2, BlockPosition var3, EnumDirection var4) {
      this.a(var1, var3, Blocks.COCOA.getBlockData().set(BlockCocoa.AGE, Integer.valueOf(var2)).set(BlockCocoa.FACING, var4));
   }
   ...
   static {
      a = Blocks.LOG.getBlockData().set(BlockLog1.VARIANT, BlockWood.EnumLogVariant.OAK);
