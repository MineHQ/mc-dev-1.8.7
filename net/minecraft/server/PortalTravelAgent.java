...
public class PortalTravelAgent {
         ...
         for(int var8 = -2; var8 <= 2; ++var8) {
            for(int var9 = -2; var9 <= 2; ++var9) {
               for(int var10 = -1; var10 < 3; ++var10) {
                  ...
                  this.a.setTypeUpdate(new BlockPosition(var11, var12, var13), var14?Blocks.OBSIDIAN.getBlockData():Blocks.AIR.getBlockData());
               }
            }
         }
   ...
   public boolean b(Entity var1, float var2) {
      ...
      if(this.c.contains(var10)) {
         PortalTravelAgent.ChunkCoordinatesPortal var12 = (PortalTravelAgent.ChunkCoordinatesPortal)this.c.getEntry(var10);
         var4 = 0.0D;
         var9 = var12;
         var12.c = this.a.getTime();
         var8 = false;
      } else {
         ...
         for(int var13 = -128; var13 <= 128; ++var13) {
            ...
            for(int var14 = -128; var14 <= 128; ++var14) {
               for(BlockPosition var15 = var30.a(var13, this.a.V() - 1 - var30.getY(), var14); var15.getY() >= 0; var15 = var16) {
                  var16 = var15.down();
      ...
      if(var4 >= 0.0D) {
         if(var8) {
            this.c.put(var10, new PortalTravelAgent.ChunkCoordinatesPortal((BlockPosition)var9, this.a.getTime()));
         ...
         ShapeDetector.ShapeDetectorCollection var18 = Blocks.PORTAL.f(this.a, (BlockPosition)var9);
         boolean var19 = var18.b().e().c() == EnumDirection.EnumAxisDirection.NEGATIVE;
         double var20 = var18.b().k() == EnumDirection.EnumAxis.X?(double)var18.a().getZ():(double)var18.a().getX();
         var32 = (double)(var18.a().getY() + 1) - var1.aG().b * (double)var18.e();
         if(var19) {
            ++var20;
         }

         if(var18.b().k() == EnumDirection.EnumAxis.X) {
         ...
         float var24 = 0.0F;
         float var25 = 0.0F;
         if(var18.b().opposite() == var1.aH()) {
            var22 = 1.0F;
            var23 = 1.0F;
         } else if(var18.b().opposite() == var1.aH().opposite()) {
            var22 = -1.0F;
            var23 = -1.0F;
         } else if(var18.b().opposite() == var1.aH().e()) {
            var24 = 1.0F;
            var25 = -1.0F;
         } else {
            var24 = -1.0F;
         ...
         var1.yaw = var2 - (float)(var1.aH().opposite().b() * 90) + (float)(var18.b().b() * 90);
   ...
   public boolean a(Entity var1) {
      ...
      for(var14 = var5 - var2; var14 <= var5 + var2; ++var14) {
         ...
         for(var17 = var7 - var2; var17 <= var7 + var2; ++var17) {
            ...
            for(var20 = this.a.V() - 1; var20 >= 0; --var20) {
               if(this.a.isEmpty(var13.c(var14, var20, var17))) {
                  while(var20 > 0 && this.a.isEmpty(var13.c(var14, var20 - 1, var17))) {
                     --var20;
                  }
      ...
      if(var3 < 0.0D) {
         var9 = MathHelper.clamp(var9, 70, this.a.V() - 10);
         var16 = var9;
         ...
         for(var20 = -1; var20 <= 1; ++var20) {
            for(var21 = 1; var21 < 3; ++var21) {
               for(var22 = -1; var22 < 3; ++var22) {
                  ...
                  this.a.setTypeUpdate(new BlockPosition(var23, var24, var25), var35?Blocks.OBSIDIAN.getBlockData():Blocks.AIR.getBlockData());
               }
            }
         }
      }

      IBlockData var32 = Blocks.PORTAL.getBlockData().set(BlockPortal.AXIS, var31 != 0?EnumDirection.EnumAxis.X:EnumDirection.EnumAxis.Z);
   ...
   public void a(long var1) {
      if(var1 % 100L == 0L) {
         ...
         while(true) {
            Long var6;
            PortalTravelAgent.ChunkCoordinatesPortal var7;
            do {
               if(!var3.hasNext()) {
                  return;
               }
               ...
               var6 = (Long)var3.next();
               var7 = (PortalTravelAgent.ChunkCoordinatesPortal)this.c.getEntry(var6.longValue());
   ...
   public class ChunkCoordinatesPortal extends BlockPosition {
      ...
      public ChunkCoordinatesPortal(BlockPosition var2, long var3) {
