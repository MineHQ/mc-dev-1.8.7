...
public class PersistentCollection {
   ...
   public PersistentBase get(Class<? extends PersistentBase> var1, String var2) {
   ...
   private void a(PersistentBase var1) {
      if(this.b != null) {
         try {
            File var2 = this.b.getDataFile(var1.id);
            if(var2 != null) {
               ...
               NBTCompressedStreamTools.a((NBTTagCompound)var4, (OutputStream)var5);
               var5.close();
            }
      ...
      if(this.b == null) {
         ...
         try {
            ...
            if(var3 != null) {
               ...
               NBTCompressedStreamTools.a((NBTTagCompound)var4, (DataOutput)var9);
               var9.close();
            }
         } catch (Exception var8) {
            var8.printStackTrace();
