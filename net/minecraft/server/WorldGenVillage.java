...
public class WorldGenVillage extends StructureGenerator {
   ...
   public WorldGenVillage(Map<String, String> var1) {
      this();
   ...
   public static class WorldGenVillageStart extends StructureStart {
      ...
      public WorldGenVillageStart(World var1, Random var2, int var3, int var4, int var5) {
         ...
         WorldGenVillagePieces.WorldGenVillageStartPiece var7 = new WorldGenVillagePieces.WorldGenVillageStartPiece(var1.getWorldChunkManager(), 0, var2, (var3 << 4) + 2, (var4 << 4) + 2, var6, var5);
         this.a.add(var7);
         ...
         while(var13.hasNext()) {
            ...
            if(!(var12 instanceof WorldGenVillagePieces.WorldGenVillageRoadPiece)) {
               ++var10;
            }
         }
