...
public class PathfinderGoalMoveIndoors extends PathfinderGoal {
   ...
   public boolean a() {
      ...
      if((!this.a.world.w() || this.a.world.S() && !this.a.world.getBiome(var1).e()) && !this.a.world.worldProvider.o()) {
   ...
   public void c() {
      ...
      if(this.a.b(var1) > 256.0D) {
         Vec3D var5 = RandomPositionGenerator.a(this.a, 14, 3, new Vec3D((double)var2 + 0.5D, (double)var3, (double)var4 + 0.5D));
         if(var5 != null) {
