...
public class WorldGenLargeFeature extends StructureGenerator {
   private static final List<BiomeBase> d;
   ...
   public WorldGenLargeFeature(Map<String, String> var1) {
      this();
   ...
   protected boolean a(int var1, int var2) {
      ...
      if(var3 == var5 && var4 == var6) {
         BiomeBase var8 = this.c.getWorldChunkManager().getBiome(new BlockPosition(var3 * 16 + 8, 0, var4 * 16 + 8));
         if(var8 == null) {
            return false;
         }
   ...
   public static class WorldGenLargeFeatureStart extends StructureStart {
      ...
      public WorldGenLargeFeatureStart(World var1, Random var2, int var3, int var4) {
         super(var3, var4);
         BiomeBase var5 = var1.getBiome(new BlockPosition(var3 * 16 + 8, 0, var4 * 16 + 8));
