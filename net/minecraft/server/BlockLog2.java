...
public class BlockLog2 extends BlockLogAbstract {
   ...
   public MaterialMapColor g(IBlockData var1) {
      ...
      switch(BlockLog2.SyntheticClass_1.b[((BlockLogAbstract.EnumLogRotation)var1.get(AXIS)).ordinal()]) {
      case 1:
      case 2:
      case 3:
      default:
         switch(BlockLog2.SyntheticClass_1.a[var2.ordinal()]) {
         case 1:
         default:
   ...
   public int toLegacyData(IBlockData var1) {
      byte var2 = 0;
      int var3 = var2 | ((BlockWood.EnumLogVariant)var1.get(VARIANT)).a() - 4;
      switch(BlockLog2.SyntheticClass_1.b[((BlockLogAbstract.EnumLogRotation)var1.get(AXIS)).ordinal()]) {
      case 1:
         var3 |= 4;
         break;
   ...
   protected ItemStack i(IBlockData var1) {
      return new ItemStack(Item.getItemOf(this), 1, ((BlockWood.EnumLogVariant)var1.get(VARIANT)).a() - 4);
   }

   public int getDropData(IBlockData var1) {
      return ((BlockWood.EnumLogVariant)var1.get(VARIANT)).a() - 4;
   }
