...
public class BiomeMesa extends BiomeBase {
               ...
               if(var17 == -1) {
                  ...
                  if(var19 < var23 - 1) {
                     ...
                     if(var24.getBlock() == Blocks.STAINED_HARDENED_CLAY) {
                        var3.a(var11, var19, var10, var24.getBlock().getBlockData().set(BlockCloth.COLOR, EnumColor.ORANGE));
                     }
                     ...
                     if(var19 >= 64 && var19 <= 127) {
                        ...
                        var21 = Blocks.STAINED_HARDENED_CLAY.getBlockData().set(BlockCloth.COLOR, EnumColor.ORANGE);
                     }
                  ...
                  --var17;
                  if(var26) {
                     var3.a(var11, var19, var10, Blocks.STAINED_HARDENED_CLAY.getBlockData().set(BlockCloth.COLOR, EnumColor.ORANGE));
                  } else {
                     var21 = this.a(var4, var19, var5);
                     var3.a(var11, var19, var10, var21);
                  }
   ...
   private void a(long var1) {
      ...
      for(var4 = 0; var4 < 64; ++var4) {
         ...
         if(var4 < 64) {
            this.aD[var4] = Blocks.STAINED_HARDENED_CLAY.getBlockData().set(BlockCloth.COLOR, EnumColor.ORANGE);
         }
      }
      ...
      for(var5 = 0; var5 < var4; ++var5) {
         ...
         for(var8 = 0; var7 + var8 < 64 && var8 < var6; ++var8) {
            this.aD[var7 + var8] = Blocks.STAINED_HARDENED_CLAY.getBlockData().set(BlockCloth.COLOR, EnumColor.YELLOW);
         }
      }
      ...
      for(var6 = 0; var6 < var5; ++var6) {
         ...
         for(var9 = 0; var8 + var9 < 64 && var9 < var7; ++var9) {
            this.aD[var8 + var9] = Blocks.STAINED_HARDENED_CLAY.getBlockData().set(BlockCloth.COLOR, EnumColor.BROWN);
         }
      }
      ...
      for(var7 = 0; var7 < var6; ++var7) {
         ...
         for(int var10 = 0; var9 + var10 < 64 && var10 < var8; ++var10) {
            this.aD[var9 + var10] = Blocks.STAINED_HARDENED_CLAY.getBlockData().set(BlockCloth.COLOR, EnumColor.RED);
         }
      }
      ...
      for(var9 = 0; var9 < var7; ++var9) {
         ...
         for(int var11 = 0; var8 + var11 < 64 && var11 < var12; ++var11) {
            this.aD[var8 + var11] = Blocks.STAINED_HARDENED_CLAY.getBlockData().set(BlockCloth.COLOR, EnumColor.WHITE);
            if(var8 + var11 > 1 && var3.nextBoolean()) {
               this.aD[var8 + var11 - 1] = Blocks.STAINED_HARDENED_CLAY.getBlockData().set(BlockCloth.COLOR, EnumColor.SILVER);
            }
