...
public class PlayerSelector {
   ...
   private static final Set<String> d = Sets.newHashSet((Object[])(new String[]{"x", "y", "z", "dx", "dy", "dz", "rm", "r"}));

   public static EntityPlayer getPlayer(ICommandListener var0, String var1) {
      return (EntityPlayer)getEntity(var0, var1, EntityPlayer.class);
   }

   public static <T extends Entity> T getEntity(ICommandListener var0, String var1, Class<? extends T> var2) {
      List var3 = getPlayers(var0, var1, var2);
      return var3.size() == 1?(Entity)var3.get(0):null;
   }

   public static IChatBaseComponent getPlayerNames(ICommandListener var0, String var1) {
   ...
   public static <T extends Entity> List<T> getPlayers(ICommandListener var0, String var1, Class<? extends T> var2) {
      ...
      if(var3.matches() && var0.a(1, "@")) {
         ...
         if(!b(var0, var4)) {
            ...
            BlockPosition var6 = b(var4, var0.getChunkCoordinates());
   ...
   private static List<World> a(ICommandListener var0, Map<String, String> var1) {
      ArrayList var2 = Lists.newArrayList();
      if(h(var1)) {
         var2.add(var0.getWorld());
      } else {
         Collections.addAll(var2, MinecraftServer.getServer().worldServer);
      }

      return var2;
   }

   private static <T extends Entity> boolean b(ICommandListener var0, Map<String, String> var1) {
   ...
   private static List<Predicate<Entity>> a(Map<String, String> var0, String var1) {
      ...
      if((var3 == null || !var1.equals("e")) && !var7) {
         ...
         var2.add(new Predicate() {
            public boolean a(Entity var1) {
               return EntityTypes.a(var1, var3) != var4;
            }
   ...
   private static List<Predicate<Entity>> b(Map<String, String> var0) {
   ...
   private static List<Predicate<Entity>> c(Map<String, String> var0) {
      ArrayList var1 = Lists.newArrayList();
         ...
         var1.add(new Predicate() {
            public boolean a(Entity var1) {
               if(!(var1 instanceof EntityLiving)) {
                  ...
                  ScoreboardTeamBase var3x = var2x.getScoreboardTeam();
   ...
   private static List<Predicate<Entity>> e(Map<String, String> var0) {
      ...
      if(var2 != null && var2.size() > 0) {
         var1.add(new Predicate() {
            public boolean a(Entity var1) {
               Scoreboard var2x = MinecraftServer.getServer().getWorldServer(0).getScoreboard();
               ...
               do {
                  ...
                  ScoreboardObjective var7 = var2x.getObjective(var5);
                  if(var7 == null) {
                     return false;
                  }
                  ...
                  ScoreboardScore var9 = var2x.getPlayerScoreForObjective(var8, var7);
                  var10 = var9.getScore();
   ...
   private static List<Predicate<Entity>> a(Map<String, String> var0, final BlockPosition var1) {
      ArrayList var2 = Lists.newArrayList();
   ...
   private static List<Predicate<Entity>> g(Map<String, String> var0) {
      ArrayList var1 = Lists.newArrayList();
      final int var2;
      final int var3;
      if(var0.containsKey("rym") || var0.containsKey("ry")) {
         ...
         var1.add(new Predicate() {
            public boolean a(Entity var1) {
               int var2x = PlayerSelector.a((int)Math.floor((double)var1.yaw));
      ...
      if(var0.containsKey("rxm") || var0.containsKey("rx")) {
         ...
         var1.add(new Predicate() {
            public boolean a(Entity var1) {
               int var2x = PlayerSelector.a((int)Math.floor((double)var1.pitch));
               return var2 > var3?var2x >= var2 || var2x <= var3:var2x >= var2 && var2x <= var3;
            }
   ...
   private static <T extends Entity> List<T> a(Map<String, String> var0, Class<? extends T> var1, List<Predicate<Entity>> var2, String var3, World var4, BlockPosition var5) {
      ...
      Predicate var15 = Predicates.and(IEntitySelector.a, var14);
      if(var5 != null) {
         ...
         if(!var0.containsKey("dx") && !var0.containsKey("dy") && !var0.containsKey("dz")) {
            ...
            if(var8 && var18 && !var9) {
               Predicate var20 = new Predicate() {
                  public boolean a(Entity var1) {
                     return var1.locX >= var19.a && var1.locY >= var19.b && var1.locZ >= var19.c?var1.locX < var19.d && var1.locY < var19.e && var1.locZ < var19.f:false;
                  }
   ...
   private static <T extends Entity> List<T> a(List<T> var0, Map<String, String> var1, ICommandListener var2, Class<? extends T> var3, String var4, final BlockPosition var5) {
   ...
   private static BlockPosition b(Map<String, String> var0, BlockPosition var1) {
   ...
   public static boolean isList(String var0) {
   ...
   public static boolean isPattern(String var0) {
