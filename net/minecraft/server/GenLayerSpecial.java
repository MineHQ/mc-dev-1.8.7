...
public class GenLayerSpecial extends GenLayer {
   ...
   public GenLayerSpecial(long var1, GenLayer var3, GenLayerSpecial.EnumGenLayerSpecial var4) {
      super(var1);
      this.a = var3;
      this.c = var4;
   }
   ...
   static class SyntheticClass_1 {
      ...
      static {
         try {
            a[GenLayerSpecial.EnumGenLayerSpecial.COOL_WARM.ordinal()] = 1;
         } catch (NoSuchFieldError var3) {
            ;
         }

         try {
            a[GenLayerSpecial.EnumGenLayerSpecial.HEAT_ICE.ordinal()] = 2;
         } catch (NoSuchFieldError var2) {
            ;
         }

         try {
            a[GenLayerSpecial.EnumGenLayerSpecial.SPECIAL.ordinal()] = 3;
