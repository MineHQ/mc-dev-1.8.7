      ...
      for(int var5 = 0; var5 < var1.getSize(); ++var5) {
         ...
         if(var6 != null) {
            if(var6.getItem() instanceof ItemArmor) {
               ...
               if(var7.x_() != ItemArmor.EnumArmorMaterial.LEATHER || var3 != null) {
                  return false;
               }
      ...
      for(var7 = 0; var7 < var1.getSize(); ++var7) {
         ...
         if(var8 != null) {
            if(var8.getItem() instanceof ItemArmor) {
               ...
               if(var6.x_() != ItemArmor.EnumArmorMaterial.LEATHER || var2 != null) {
                  return null;
               }
               ...
               float[] var14 = EntitySheep.a(EnumColor.fromInvColorIndex(var8.getData()));
