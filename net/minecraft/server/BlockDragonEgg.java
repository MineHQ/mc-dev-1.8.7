...
public class BlockDragonEgg extends Block {
   ...
   private void e(World var1, BlockPosition var2) {
      if(BlockFalling.canFall(var1, var2.down()) && var2.getY() >= 0) {
         byte var3 = 32;
         if(!BlockFalling.instaFall && var1.areChunksLoadedBetween(var2.a(-var3, -var3, -var3), var2.a(var3, var3, var3))) {
            var1.addEntity(new EntityFallingBlock(var1, (double)((float)var2.getX() + 0.5F), (double)var2.getY(), (double)((float)var2.getZ() + 0.5F), this.getBlockData()));
         } else {
            var1.setAir(var2);
            ...
            if(var4.getY() > 0) {
               var1.setTypeAndData(var4, this.getBlockData(), 2);
            }
         }
   ...
   private void f(World var1, BlockPosition var2) {
      ...
      if(var3.getBlock() == this) {
         for(int var4 = 0; var4 < 1000; ++var4) {
            BlockPosition var5 = var2.a(var1.random.nextInt(16) - var1.random.nextInt(16), var1.random.nextInt(8) - var1.random.nextInt(8), var1.random.nextInt(16) - var1.random.nextInt(16));
