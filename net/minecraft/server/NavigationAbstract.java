...
public abstract class NavigationAbstract {
   ...
   public PathEntity a(BlockPosition var1) {
      if(!this.b()) {
         ...
         PathEntity var6 = this.j.a((IBlockAccess)var5, (Entity)this.b, (BlockPosition)var1, var2);
   ...
   public PathEntity a(Entity var1) {
      if(!this.b()) {
         ...
         ChunkCache var5 = new ChunkCache(this.c, var3.a(-var4, -var4, -var4), var3.a(var4, var4, var4), 0);
         PathEntity var6 = this.j.a((IBlockAccess)var5, (Entity)this.b, (Entity)var1, var2);
         this.c.methodProfiler.b();
         return var6;
      }
   }
