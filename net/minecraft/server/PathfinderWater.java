...
public class PathfinderWater extends PathfinderAbstract {
   ...
   public PathPoint a(Entity var1) {
      return this.a(MathHelper.floor(var1.getBoundingBox().a), MathHelper.floor(var1.getBoundingBox().b + 0.5D), MathHelper.floor(var1.getBoundingBox().c));
   }
   ...
   public int a(PathPoint[] var1, Entity var2, PathPoint var3, PathPoint var4, float var5) {
      ...
      for(int var9 = 0; var9 < var8; ++var9) {
         ...
         PathPoint var11 = this.a(var2, var3.a + var10.getAdjacentX(), var3.b + var10.getAdjacentY(), var3.c + var10.getAdjacentZ());
      ...
      for(int var6 = var2; var6 < var2 + this.c; ++var6) {
         for(int var7 = var3; var7 < var3 + this.d; ++var7) {
            for(int var8 = var4; var8 < var4 + this.e; ++var8) {
               Block var9 = this.a.getType(var5.c(var6, var7, var8)).getBlock();
