...
public class WorldGenLakes extends WorldGenerator {
   ...
   public boolean generate(World var1, Random var2, BlockPosition var3) {
      for(var3 = var3.a(-8, 0, -8); var3.getY() > 5 && var1.isEmpty(var3); var3 = var3.down()) {
         ;
      }
         ...
         for(var6 = 0; var6 < 16; ++var6) {
            for(var30 = 0; var30 < 16; ++var30) {
               for(var8 = 0; var8 < 8; ++var8) {
                  ...
                  if(var31) {
                     Material var10 = var1.getType(var3.a(var6, var8, var30)).getBlock().getMaterial();
                     if(var8 >= 4 && var10.isLiquid()) {
                        return false;
                     }

                     if(var8 < 4 && !var10.isBuildable() && var1.getType(var3.a(var6, var8, var30)).getBlock() != this.a) {
                        return false;
                     }
                  }
               }
            ...
            for(var30 = 0; var30 < 16; ++var30) {
               for(var8 = 0; var8 < 8; ++var8) {
                  if(var4[(var6 * 16 + var30) * 8 + var8]) {
                     var1.setTypeAndData(var3.a(var6, var8, var30), var8 >= 4?Blocks.AIR.getBlockData():this.a.getBlockData(), 2);
                  }
               }
            }
         }
         ...
         for(var6 = 0; var6 < 16; ++var6) {
            for(var30 = 0; var30 < 16; ++var30) {
               for(var8 = 4; var8 < 8; ++var8) {
                  if(var4[(var6 * 16 + var30) * 8 + var8]) {
                     BlockPosition var32 = var3.a(var6, var8 - 1, var30);
                     if(var1.getType(var32).getBlock() == Blocks.DIRT && var1.b(EnumSkyBlock.SKY, var3.a(var6, var8, var30)) > 0) {
                        BiomeBase var33 = var1.getBiome(var32);
                        if(var33.ak.getBlock() == Blocks.MYCELIUM) {
                           var1.setTypeAndData(var32, Blocks.MYCELIUM.getBlockData(), 2);
                        } else {
                           var1.setTypeAndData(var32, Blocks.GRASS.getBlockData(), 2);
                        }
                     }
                  }
               }
         ...
         if(this.a.getMaterial() == Material.LAVA) {
            for(var6 = 0; var6 < 16; ++var6) {
               for(var30 = 0; var30 < 16; ++var30) {
                  for(var8 = 0; var8 < 8; ++var8) {
                     var31 = !var4[(var6 * 16 + var30) * 8 + var8] && (var6 < 15 && var4[((var6 + 1) * 16 + var30) * 8 + var8] || var6 > 0 && var4[((var6 - 1) * 16 + var30) * 8 + var8] || var30 < 15 && var4[(var6 * 16 + var30 + 1) * 8 + var8] || var30 > 0 && var4[(var6 * 16 + (var30 - 1)) * 8 + var8] || var8 < 7 && var4[(var6 * 16 + var30) * 8 + var8 + 1] || var8 > 0 && var4[(var6 * 16 + var30) * 8 + (var8 - 1)]);
                     if(var31 && (var8 < 4 || var2.nextInt(2) != 0) && var1.getType(var3.a(var6, var8, var30)).getBlock().getMaterial().isBuildable()) {
                        var1.setTypeAndData(var3.a(var6, var8, var30), Blocks.STONE.getBlockData(), 2);
                     }
                  }
               }
            }
            ...
            for(var6 = 0; var6 < 16; ++var6) {
               for(var30 = 0; var30 < 16; ++var30) {
                  ...
                  if(var1.v(var3.a(var6, var34, var30))) {
                     var1.setTypeAndData(var3.a(var6, var34, var30), Blocks.ICE.getBlockData(), 2);
                  }
               }
            }
         }
