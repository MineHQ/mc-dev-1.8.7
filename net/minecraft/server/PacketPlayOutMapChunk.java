...
public class PacketPlayOutMapChunk implements Packet<PacketListenerPlayOut> {
   ...
   public PacketPlayOutMapChunk(Chunk var1, boolean var2, int var3) {
      ...
      this.b = var1.locZ;
      this.d = var2;
      this.c = a(var1, var2, !var1.getWorld().worldProvider.o(), var3);
   }
   ...
   public static PacketPlayOutMapChunk.ChunkMap a(Chunk var0, boolean var1, boolean var2, int var3) {
      ChunkSection[] var4 = var0.getSections();
      PacketPlayOutMapChunk.ChunkMap var5 = new PacketPlayOutMapChunk.ChunkMap();
      ...
      for(var15 = var6.iterator(); var15.hasNext(); var7 = a(var9.getEmittedLightArray().a(), var5.a, var7)) {
         var9 = (ChunkSection)var15.next();
      }

      if(var2) {
         for(var15 = var6.iterator(); var15.hasNext(); var7 = a(var9.getSkyLightArray().a(), var5.a, var7)) {
            var9 = (ChunkSection)var15.next();
         }
      }
