...
public class ChunkProviderGenerate implements IChunkProvider {
   ...
   public ChunkProviderGenerate(World var1, long var2, boolean var4, String var5) {
      ...
      if(var5 != null) {
         this.r = CustomWorldSettingsFinal.CustomWorldSettings.a(var5).b();
   ...
   public void a(int var1, int var2, ChunkSnapshot var3) {
      this.B = this.m.getWorldChunkManager().getBiomes(this.B, var1 * 4 - 2, var2 * 4 - 2, 10, 10);
   ...
   public void getChunkAt(IChunkProvider var1, int var2, int var3) {
      ...
      if(var7 != BiomeBase.DESERT && var7 != BiomeBase.DESERT_HILLS && this.r.A && !var12 && this.h.nextInt(this.r.B) == 0) {
         ...
         (new WorldGenLakes(Blocks.WATER)).generate(this.m, this.h, var6.a(var14, var15, var16));
      }
      ...
      if(!var12 && this.h.nextInt(this.r.D / 10) == 0 && this.r.C) {
         ...
         if(var15 < this.m.F() || this.h.nextInt(this.r.D / 8) == 0) {
            (new WorldGenLakes(Blocks.LAVA)).generate(this.m, this.h, var6.a(var14, var15, var16));
         }
      }
      ...
      if(this.r.s) {
         for(var14 = 0; var14 < this.r.t; ++var14) {
            ...
            (new WorldGenDungeons()).generate(this.m, this.h, var6.a(var15, var16, var17));
         }
      }
      ...
      for(var14 = 0; var14 < 16; ++var14) {
         for(var15 = 0; var15 < 16; ++var15) {
            BlockPosition var18 = this.m.q(var6.a(var14, 0, var15));
            BlockPosition var19 = var18.down();
            if(this.m.v(var19)) {
               this.m.setTypeAndData(var19, Blocks.ICE.getBlockData(), 2);
            }

            if(this.m.f(var18, true)) {
               this.m.setTypeAndData(var18, Blocks.SNOW_LAYER.getBlockData(), 2);
            }
         }
      }
