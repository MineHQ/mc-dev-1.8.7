...
public class CustomWorldSettingsFinal {
   ...
   private CustomWorldSettingsFinal(CustomWorldSettingsFinal.CustomWorldSettings var1) {
      this.a = var1.b;
      this.b = var1.c;
      this.c = var1.d;
      this.d = var1.e;
   ...
   // $FF: synthetic method
   CustomWorldSettingsFinal(CustomWorldSettingsFinal.CustomWorldSettings var1, CustomWorldSettingsFinal.SyntheticClass_1 var2) {
      this(var1);
   }
   ...
   public static class CustomWorldSettingsSerializer implements JsonDeserializer<CustomWorldSettingsFinal.CustomWorldSettings>, JsonSerializer<CustomWorldSettingsFinal.CustomWorldSettings> {
      ...
      public CustomWorldSettingsFinal.CustomWorldSettings a(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
         ...
         CustomWorldSettingsFinal.CustomWorldSettings var5 = new CustomWorldSettingsFinal.CustomWorldSettings();

         try {
            var5.b = ChatDeserializer.a(var4, "coordinateScale", var5.b);
            var5.c = ChatDeserializer.a(var4, "heightScale", var5.c);
            var5.e = ChatDeserializer.a(var4, "lowerLimitScale", var5.e);
            var5.d = ChatDeserializer.a(var4, "upperLimitScale", var5.d);
            var5.f = ChatDeserializer.a(var4, "depthNoiseScaleX", var5.f);
            var5.g = ChatDeserializer.a(var4, "depthNoiseScaleZ", var5.g);
            var5.h = ChatDeserializer.a(var4, "depthNoiseScaleExponent", var5.h);
            var5.i = ChatDeserializer.a(var4, "mainNoiseScaleX", var5.i);
            var5.j = ChatDeserializer.a(var4, "mainNoiseScaleY", var5.j);
            var5.k = ChatDeserializer.a(var4, "mainNoiseScaleZ", var5.k);
            var5.l = ChatDeserializer.a(var4, "baseSize", var5.l);
            var5.m = ChatDeserializer.a(var4, "stretchY", var5.m);
            var5.n = ChatDeserializer.a(var4, "biomeDepthWeight", var5.n);
            var5.o = ChatDeserializer.a(var4, "biomeDepthOffset", var5.o);
            var5.p = ChatDeserializer.a(var4, "biomeScaleWeight", var5.p);
            var5.q = ChatDeserializer.a(var4, "biomeScaleOffset", var5.q);
            var5.r = ChatDeserializer.a(var4, "seaLevel", var5.r);
            var5.s = ChatDeserializer.a(var4, "useCaves", var5.s);
            var5.t = ChatDeserializer.a(var4, "useDungeons", var5.t);
            var5.u = ChatDeserializer.a(var4, "dungeonChance", var5.u);
            var5.v = ChatDeserializer.a(var4, "useStrongholds", var5.v);
            var5.w = ChatDeserializer.a(var4, "useVillages", var5.w);
            var5.x = ChatDeserializer.a(var4, "useMineShafts", var5.x);
            var5.y = ChatDeserializer.a(var4, "useTemples", var5.y);
            var5.z = ChatDeserializer.a(var4, "useMonuments", var5.z);
            var5.A = ChatDeserializer.a(var4, "useRavines", var5.A);
            var5.B = ChatDeserializer.a(var4, "useWaterLakes", var5.B);
            var5.C = ChatDeserializer.a(var4, "waterLakeChance", var5.C);
            var5.D = ChatDeserializer.a(var4, "useLavaLakes", var5.D);
            var5.E = ChatDeserializer.a(var4, "lavaLakeChance", var5.E);
            var5.F = ChatDeserializer.a(var4, "useLavaOceans", var5.F);
            var5.G = ChatDeserializer.a(var4, "fixedBiome", var5.G);
            ...
            var5.H = ChatDeserializer.a(var4, "biomeSize", var5.H);
            var5.I = ChatDeserializer.a(var4, "riverSize", var5.I);
            var5.J = ChatDeserializer.a(var4, "dirtSize", var5.J);
            var5.K = ChatDeserializer.a(var4, "dirtCount", var5.K);
            var5.L = ChatDeserializer.a(var4, "dirtMinHeight", var5.L);
            var5.M = ChatDeserializer.a(var4, "dirtMaxHeight", var5.M);
            var5.N = ChatDeserializer.a(var4, "gravelSize", var5.N);
            var5.O = ChatDeserializer.a(var4, "gravelCount", var5.O);
            var5.P = ChatDeserializer.a(var4, "gravelMinHeight", var5.P);
            var5.Q = ChatDeserializer.a(var4, "gravelMaxHeight", var5.Q);
            var5.R = ChatDeserializer.a(var4, "graniteSize", var5.R);
            var5.S = ChatDeserializer.a(var4, "graniteCount", var5.S);
            var5.T = ChatDeserializer.a(var4, "graniteMinHeight", var5.T);
            var5.U = ChatDeserializer.a(var4, "graniteMaxHeight", var5.U);
            var5.V = ChatDeserializer.a(var4, "dioriteSize", var5.V);
            var5.W = ChatDeserializer.a(var4, "dioriteCount", var5.W);
            var5.X = ChatDeserializer.a(var4, "dioriteMinHeight", var5.X);
            var5.Y = ChatDeserializer.a(var4, "dioriteMaxHeight", var5.Y);
            var5.Z = ChatDeserializer.a(var4, "andesiteSize", var5.Z);
            var5.aa = ChatDeserializer.a(var4, "andesiteCount", var5.aa);
            var5.ab = ChatDeserializer.a(var4, "andesiteMinHeight", var5.ab);
            var5.ac = ChatDeserializer.a(var4, "andesiteMaxHeight", var5.ac);
            var5.ad = ChatDeserializer.a(var4, "coalSize", var5.ad);
            var5.ae = ChatDeserializer.a(var4, "coalCount", var5.ae);
            var5.af = ChatDeserializer.a(var4, "coalMinHeight", var5.af);
            var5.ag = ChatDeserializer.a(var4, "coalMaxHeight", var5.ag);
            var5.ah = ChatDeserializer.a(var4, "ironSize", var5.ah);
            var5.ai = ChatDeserializer.a(var4, "ironCount", var5.ai);
            var5.aj = ChatDeserializer.a(var4, "ironMinHeight", var5.aj);
            var5.ak = ChatDeserializer.a(var4, "ironMaxHeight", var5.ak);
            var5.al = ChatDeserializer.a(var4, "goldSize", var5.al);
            var5.am = ChatDeserializer.a(var4, "goldCount", var5.am);
            var5.an = ChatDeserializer.a(var4, "goldMinHeight", var5.an);
            var5.ao = ChatDeserializer.a(var4, "goldMaxHeight", var5.ao);
            var5.ap = ChatDeserializer.a(var4, "redstoneSize", var5.ap);
            var5.aq = ChatDeserializer.a(var4, "redstoneCount", var5.aq);
            var5.ar = ChatDeserializer.a(var4, "redstoneMinHeight", var5.ar);
            var5.as = ChatDeserializer.a(var4, "redstoneMaxHeight", var5.as);
            var5.at = ChatDeserializer.a(var4, "diamondSize", var5.at);
            var5.au = ChatDeserializer.a(var4, "diamondCount", var5.au);
            var5.av = ChatDeserializer.a(var4, "diamondMinHeight", var5.av);
            var5.aw = ChatDeserializer.a(var4, "diamondMaxHeight", var5.aw);
            var5.ax = ChatDeserializer.a(var4, "lapisSize", var5.ax);
            var5.ay = ChatDeserializer.a(var4, "lapisCount", var5.ay);
            var5.az = ChatDeserializer.a(var4, "lapisCenterHeight", var5.az);
            var5.aA = ChatDeserializer.a(var4, "lapisSpread", var5.aA);
      ...
      public JsonElement a(CustomWorldSettingsFinal.CustomWorldSettings var1, Type var2, JsonSerializationContext var3) {
      ...
      public JsonElement serialize(Object var1, Type var2, JsonSerializationContext var3) {
         return this.a((CustomWorldSettingsFinal.CustomWorldSettings)var1, var2, var3);
      }
   }
