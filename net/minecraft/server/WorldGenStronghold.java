...
public class WorldGenStronghold extends StructureGenerator {
   ...
   public WorldGenStronghold(Map<String, String> var1) {
      this();
   ...
   protected StructureStart b(int var1, int var2) {
      WorldGenStronghold.WorldGenStronghold2Start var3;
      for(var3 = new WorldGenStronghold.WorldGenStronghold2Start(this.c, this.b, var1, var2); var3.b().isEmpty() || ((WorldGenStrongholdPieces.WorldGenStrongholdStart)var3.b().get(0)).b == null; var3 = new WorldGenStronghold.WorldGenStronghold2Start(this.c, this.b, var1, var2)) {
         ;
      }
