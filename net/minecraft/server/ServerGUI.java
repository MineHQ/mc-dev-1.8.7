...
public class ServerGUI extends JComponent {
   ...
   public ServerGUI(DedicatedServer var1) {
      this.c = var1;
   ...
   private JComponent c() throws Exception {
      ...
      var4.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent var1) {
            ...
            if(var2.length() > 0) {
               ServerGUI.this.c.issueCommand(var2, MinecraftServer.getServer());
            }
      ...
      Thread var5 = new Thread(new Runnable() {
         public void run() {
            ...
            while((var1 = QueueLogAppender.getNextLogEvent("ServerGuiConsole")) != null) {
               ServerGUI.this.a(var2, var3, var1);
            }
   ...
   public void a(final JTextArea var1, final JScrollPane var2, final String var3) {
      if(!SwingUtilities.isEventDispatchThread()) {
         SwingUtilities.invokeLater(new Runnable() {
            public void run() {
               ServerGUI.this.a(var1, var2, var3);
            }
         });
      } else {
