...
public class RemoteStatusListener extends RemoteConnectionThread {
   ...
   private boolean a(DatagramPacket var1) throws IOException {
      ...
      if(3 <= var3 && -2 == var2[0] && -3 == var2[1]) {
         this.a((String)("Packet \'" + StatusChallengeUtils.a(var2[2]) + "\' [" + var4 + "]"));
         switch(var2[2]) {
         case 0:
   ...
   private byte[] a(SocketAddress var1) {
      return ((RemoteStatusListener.RemoteStatusChallenge)this.t.get(var1)).c();
   }
   ...
   private Boolean c(DatagramPacket var1) {
      ...
      if(!this.t.containsKey(var2)) {
         ...
         return ((RemoteStatusListener.RemoteStatusChallenge)this.t.get(var2)).a() != StatusChallengeUtils.c(var3, 7, var1.getLength())?Boolean.valueOf(false):Boolean.valueOf(true);
      }
   }

   private void d(DatagramPacket var1) throws IOException {
      RemoteStatusListener.RemoteStatusChallenge var2 = new RemoteStatusListener.RemoteStatusChallenge(var1);
      ...
      if(this.a) {
         ...
         if(var1 >= this.h + 30000L) {
            ...
            while(var3.hasNext()) {
               ...
               if(((RemoteStatusListener.RemoteStatusChallenge)var4.getValue()).a(var1).booleanValue()) {
                  var3.remove();
               }
            }
   ...
   class RemoteStatusChallenge {
      ...
      public RemoteStatusChallenge(DatagramPacket var2) {
      ...
      public Boolean a(long var1) {
         return Boolean.valueOf(this.time < var1);
      }
