...
public class WorldGenMegaTree extends WorldGenMegaTreeAbstract {
   ...
   public boolean generate(World var1, Random var2, BlockPosition var3) {
      ...
      if(!this.a(var1, var2, var3, var4)) {
         ...
         for(int var5 = 0; var5 < var4; ++var5) {
            ...
            if(var5 < var4 - 1) {
               var6 = var1.getType(var3.a(1, var5, 0)).getBlock();
               if(var6.getMaterial() == Material.AIR || var6.getMaterial() == Material.LEAVES) {
                  this.a(var1, var3.a(1, var5, 0), this.b);
               }

               var6 = var1.getType(var3.a(1, var5, 1)).getBlock();
               if(var6.getMaterial() == Material.AIR || var6.getMaterial() == Material.LEAVES) {
                  this.a(var1, var3.a(1, var5, 1), this.b);
               }

               var6 = var1.getType(var3.a(0, var5, 1)).getBlock();
               if(var6.getMaterial() == Material.AIR || var6.getMaterial() == Material.LEAVES) {
   ...
   static {
      e = Blocks.LOG.getBlockData().set(BlockLog1.VARIANT, BlockWood.EnumLogVariant.SPRUCE);
