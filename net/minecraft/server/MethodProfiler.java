...
public class MethodProfiler {
   ...
   public List<MethodProfiler.ProfilerInfo> b(String var1) {
      if(!this.a) {
         return null;
      } else {
         ...
         while(var21.hasNext()) {
            ...
            if(var12.length() > var1.length() && var12.startsWith(var1) && var12.indexOf(".", var1.length() + 1) < 0) {
               ...
               var7.add(new MethodProfiler.ProfilerInfo(var19, var15, var17));
            }
         }
         ...
         if((float)var8 > var20) {
            var7.add(new MethodProfiler.ProfilerInfo("unspecified", (double)((float)var8 - var20) * 100.0D / (double)var8, (double)((float)var8 - var20) * 100.0D / (double)var3));
         }

         Collections.sort(var7);
         var7.add(0, new MethodProfiler.ProfilerInfo(var1, 100.0D, (double)var8 * 100.0D / (double)var3));
         return var7;
      }
   }
   ...
   public static final class ProfilerInfo implements Comparable<MethodProfiler.ProfilerInfo> {
      ...
      public ProfilerInfo(String var1, double var2, double var4) {
         this.c = var1;
         this.a = var2;
         this.b = var4;
      }

      public int a(MethodProfiler.ProfilerInfo var1) {
         return var1.a < this.a?-1:(var1.a > this.a?1:var1.c.compareTo(this.c));
      }

      // $FF: synthetic method
      public int compareTo(Object var1) {
         return this.a((MethodProfiler.ProfilerInfo)var1);
      }
   }
}
