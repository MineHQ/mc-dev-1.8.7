...
public class EntityEnderCrystal extends Entity {
   ...
   public void t_() {
      ...
      if(this.world.worldProvider instanceof WorldProviderTheEnd && this.world.getType(new BlockPosition(var1, var2, var3)).getBlock() != Blocks.FIRE) {
         this.world.setTypeUpdate(new BlockPosition(var1, var2, var3), Blocks.FIRE.getBlockData());
      }
