...
public final class Unpooled {
   ...
   public static ByteBuf wrappedBuffer(byte[] var0, int var1, int var2) {
      return var2 == 0?EMPTY_BUFFER:(var1 == 0 && var2 == var0.length?wrappedBuffer(var0):wrappedBuffer(var0).slice(var1, var2));
   }

   public static ByteBuf wrappedBuffer(ByteBuffer var0) {
      return (ByteBuf)(!var0.hasRemaining()?EMPTY_BUFFER:(var0.hasArray()?wrappedBuffer(var0.array(), var0.arrayOffset() + var0.position(), var0.remaining()).order(var0.order()):(PlatformDependent.hasUnsafe()?(var0.isReadOnly()?(var0.isDirect()?new ReadOnlyUnsafeDirectByteBuf(ALLOC, var0):new ReadOnlyByteBufferBuf(ALLOC, var0)):new UnpooledUnsafeDirectByteBuf(ALLOC, var0, var0.remaining())):(var0.isReadOnly()?new ReadOnlyByteBufferBuf(ALLOC, var0):new UnpooledDirectByteBuf(ALLOC, var0, var0.remaining())))));
   }
