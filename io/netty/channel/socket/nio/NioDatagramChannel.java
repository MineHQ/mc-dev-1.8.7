...
public final class NioDatagramChannel extends AbstractNioMessageChannel implements DatagramChannel {
   ...
   public boolean isActive() {
      ...
      return var1.isOpen() && (((Boolean)this.config.getOption(ChannelOption.DATAGRAM_CHANNEL_ACTIVE_ON_REGISTRATION)).booleanValue() && this.isRegistered() || var1.socket().isBound());
   }
   ...
   protected int doReadMessages(List<Object> var1) throws Exception {
      ...
      try {
         ...
         int var18 = var7.position();
         InetSocketAddress var9 = (InetSocketAddress)var2.receive(var7);
         if(var9 != null) {
            int var17 = var7.position() - var18;
            var5.writerIndex(var5.writerIndex() + var17);
            var4.record(var17);
   ...
   protected boolean doWriteMessage(Object var1, ChannelOutboundBuffer var2) throws Exception {
      ...
      if(var8 == 0) {
         ...
         ByteBuffer var6 = var4.internalNioBuffer(var4.readerIndex(), var8);
         int var7;
         if(var3 != null) {
