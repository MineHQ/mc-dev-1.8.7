...
public class JdkZlibEncoder extends ZlibEncoder {
   ...
   protected final ByteBuf allocateBuffer(ChannelHandlerContext var1, ByteBuf var2, boolean var3) throws Exception {
      ...
      if(this.writeHeader) {
         switch(JdkZlibEncoder.SyntheticClass_1.$SwitchMap$io$netty$handler$codec$compression$ZlibWrapper[this.wrapper.ordinal()]) {
         case 1:
   ...
   // $FF: synthetic method
   // $FF: bridge method
   protected ByteBuf allocateBuffer(ChannelHandlerContext var1, Object var2, boolean var3) throws Exception {
      return this.allocateBuffer(var1, (ByteBuf)var2, var3);
   }
