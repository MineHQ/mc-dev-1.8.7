...
public class SpdyFrameDecoder {
   ...
   public void decode(ByteBuf var1) {
      while(true) {
         boolean var2;
         int var3;
         switch(SpdyFrameDecoder.SyntheticClass_1.$SwitchMap$io$netty$handler$codec$spdy$SpdyFrameDecoder$State[this.state.ordinal()]) {
         case 1:
   ...
   static class SyntheticClass_1 {
      // $FF: synthetic field
      static final int[] $SwitchMap$io$netty$handler$codec$spdy$SpdyFrameDecoder$State = new int[SpdyFrameDecoder.State.values().length];
