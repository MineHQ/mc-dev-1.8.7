...
public class SpdyFrameCodec extends ByteToMessageDecoder implements SpdyFrameDecoderDelegate, ChannelOutboundHandler {
   ...
   protected SpdyFrameCodec(SpdyVersion var1, int var2, SpdyHeaderBlockDecoder var3, SpdyHeaderBlockEncoder var4) {
   ...
   public void write(ChannelHandlerContext var1, Object var2, ChannelPromise var3) throws Exception {
      ...
      if(var2 instanceof SpdyDataFrame) {
         ...
         if(var2 instanceof SpdySynStreamFrame) {
            ...
            var6 = this.spdyHeaderBlockEncoder.encode(var22);
            ...
            var6 = this.spdyHeaderBlockEncoder.encode(var23);
            ...
            var6 = this.spdyHeaderBlockEncoder.encode(var28);
