...
public class SpdySessionHandler extends ChannelDuplexHandler {
      ...
      if(var2 instanceof SpdyDataFrame) {
         ...
         if(var19 < 0) {
            while(var16.content().readableBytes() > this.initialReceiveWindowSize) {
               DefaultSpdyDataFrame var20 = new DefaultSpdyDataFrame(var4, var16.content().readSlice(this.initialReceiveWindowSize).retain());
   ...
   public void channelInactive(ChannelHandlerContext var1) throws Exception {
      ...
      while(var2.hasNext()) {
         ...
         this.removeStream(var3.intValue(), var1.newSucceededFuture());
      }
   ...
   private void handleOutboundMessage(final ChannelHandlerContext var1, Object var2, ChannelPromise var3) throws Exception {
      ...
      if(var2 instanceof SpdyDataFrame) {
         ...
         if(var7 < var6) {
            ...
            DefaultSpdyDataFrame var9 = new DefaultSpdyDataFrame(var5, var16.content().readSlice(var7).retain());
            this.spdySession.putPendingWrite(var5, new SpdySession.PendingWrite(var16, var3));
   ...
   private synchronized boolean acceptStream(int var1, byte var2, boolean var3, boolean var4) {
