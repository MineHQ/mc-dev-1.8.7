...
public class SpdyFrameEncoder {
   ...
   public ByteBuf encodeDataFrame(ByteBufAllocator var1, int var2, boolean var3, ByteBuf var4) {
      ...
      var7.writeInt(var2 & Integer.MAX_VALUE);
      var7.writeByte(var5);
   ...
   public ByteBuf encodeSettingsFrame(ByteBufAllocator var1, SpdySettingsFrame var2) {
      ...
      while(var8.hasNext()) {
         ...
         byte var10 = 0;
         if(var2.isPersistValue(var9.intValue())) {
            var10 = (byte)(var10 | 1);
         }

         if(var2.isPersisted(var9.intValue())) {
            var10 = (byte)(var10 | 2);
         }

         var7.writeByte(var10);
         var7.writeMedium(var9.intValue());
         var7.writeInt(var2.getValue(var9.intValue()));
      }
